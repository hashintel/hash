...
Once they have entered or selected data, ensure you design a loading state that lets them know if they need to wait a moment for the data to load. If the loading process might take a while, giving them buttons to pause and resume may also be a good idea. Giving users clear feedback and [visibilty of system status](https://www.nngroup.com/articles/visibility-system-status/) helps them feel informed and in control.
