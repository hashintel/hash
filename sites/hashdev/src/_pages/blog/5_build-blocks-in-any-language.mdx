...
4.  send the messages your block needs to update or retrieve data, as specified in the Graph Service specification
...
The Graph Service supplies an interface for managing Entities, Entity Types, and Links. Entity Types are _domain types_ defined in embedding applications, and Entities are instances of these.
