---
authorPhoto: blog/authors/ahmad-sattar.png
...
author: "Senior Ahmad Sattar Atta"
...
These types are all valid message structures for communicating with the Graph Service in the embedding application.
