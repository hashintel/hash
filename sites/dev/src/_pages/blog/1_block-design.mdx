...
Nothing makes a design look better than consistency and ratios.
...
Most blocks will begin their life within any data in them. Users will have to select from a pre-existing resource, or manually enter the data themselves.
...
#### 4. Make interactive and editable elements obvious
...
#### 5. Make your blocks A11y accessible
...
#### 6. Make it easy for users to recover from mistakes

#### 7. Follow conventional icon semantics and use labels
