...
postPhoto: blog/1_block-design/DesignGuidelines_Cover.png
...
We provide a system that does this for you in the `base.css` file provided by the [block starter template](https://github.com/blockprotocol/blockprotocol/tree/main/packages/block-template)
