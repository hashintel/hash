...
When we have to use an input element that is physically seperated or distant from the data being acted upon, we're move likely to be confused about what we're editing.
