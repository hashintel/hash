...
![A diagram of a set of blocks connected through the block protocol to an embedding application on the other side](blog/1_block-design/DesignGuidelines_2.png)
...
The blocks you build will be used inside other applications; we call these "embedding application."
...
Every Block Protocol block you build must accept a `styleVariables` object that the embedding application can pass in.

This object defines a set of variables that control the basic styles of the block. We've designed these to maximise consistency and simplicity within your block. You can see the full list of these in the [styling section](#) of our documentation. Here's a rundown of the major categories:

1.  Colours - a range of shades for neutrals, primary, secondary, tertiary, warning, and danger.
2.  Typography – font family, base size, scaling ratios, and line heights
3.  Spacing – base size and scaling ratios
4.  Borders – weight, colours, and radius
5.  Box shadows
6.  Icon sizes
...
<img
  ...
  width={900}
  height={480}
  alt="A text input field with a very low contrast dropdown menu below it. Inside there is a low-constrast 'save' button and a much larger and more prominent 'delte' button."
/>
...
<img
  ...
  width={1050}
  height={414}
  alt="Two callout boxes. The first has very plain styling and limited use of colour. The second has a leopard background, many bold colours, and an unconventional novelty font."
/>
...
<img
  src="blog/1_block-design/DesignGuidelines_5.png"
  width={685}
  height={603}
...
Once they have entered or selected data, ensure you design a loading state that lets them know if they need to wait a moment for the data to load. If the loading process might take a while, giving them buttons to pause and resume it may also be a good idea. Clear feedback and [visibilty of system status](https://www.google.com/search?q=ux+visibility+system+status) is always critical to help users feel informed and in control.

<img
  src="blog/1_block-design/DesignGuidelines_6.png"
  width={661}
  height={240}
...
If the user can click, edit, manipulate, or input data anywhere in the block, make sure you visually style the element to make clear it's interactive.

This means making buttons look like buttons by giving them a different background colour and clear border.

<img
  src="blog/1_block-design/DesignGuidelines_8.png"
  width={650}
  height={178}
...
<img
  src="blog/1_block-design/DesignGuidelines_7.png"
  width={997}
  height={403}
  alt="Images of a button and a block of text with two examples. One where they pass the AA contrast ratio threshold, and nother where they're too faint and don't pass the threshold."
/>
...
If a user is filling in a form, put the "submit" button right next to the last field. If a user is applying a set of filters, put the "apply filters" button right next to the selectors. You can also use containers and spacing to indicate a button is closely related to an area of input.
...
When we have to use a control or input element that is physically seperated or distant from the data being acted upon, we're move likely to be confused about what we're editing.
...
<img
  src="blog/1_block-design/DesignGuidelines_9.png"
  width={422}
  height={189}
...
![](blog/1_block-design/DesignGuidelines_5.png)

![](blog/1_block-design/DesignGuidelines_6.png)

![](blog/1_block-design/DesignGuidelines_7.png)

![](blog/1_block-design/DesignGuidelines_8.png)

![](blog/1_block-design/DesignGuidelines_9.png)

![](blog/1_block-design/DesignGuidelines_10.png)
