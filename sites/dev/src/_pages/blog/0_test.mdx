...
<BlogPostContent>
  <Typography component="p">
    The computer only knows you've added a bunch of &lt;p&gt; tags to a page,
    but doesn't understand the contents or shape of what you've written inside
    (at least without any fancy natural language processing).
  </Typography>
</BlogPostContent>
