...
postPhotoSquare: blog/0_test/square.png
...
<ImageWithText>
  There are an infinite number of possible block types. One goal of the Block
  Protocol is to encourage developers to build and share brand new types of
  blocks that haven't been seen before, and for applications to offer users far
  more blocks than any one team could imagine or build.
  <img
    src="blog/0_test/example.png"
    alt="Example Image"
    width={200}
    height={200}
  />
...
<img
  ...
  width={200}
  height={200}
/> There are an infinite number of possible block types. One goal of the Block Protocol
is to encourage developers to build and share brand new types of blocks that haven't
been seen before, and for applications to offer users far more blocks than any one
team could imagine or build.
