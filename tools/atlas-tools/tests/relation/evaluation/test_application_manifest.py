...
from atlas_tools.relation.evaluation.domain.api import HandoffManifest, PilotRunState
...
PAID_REQUEST_CONTRACT = "720240922757e3830166e201cb58d5a31ed511cfcf1266db95d3b3b645354069"
...
def test_manifest_builders_reproduce_the_paid_pilot_artifacts() -> None:
    async def scenario() -> None:
        ...
        run_directory = ROOT / "runs/evaluate"
