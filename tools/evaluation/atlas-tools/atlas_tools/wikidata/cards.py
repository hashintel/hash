"""Corpus emission for relation cards: cards.jsonl + cards.manifest.json.
...
from atlas_tools.wikidata.sentence import make_sentence_splitter
from atlas_tools.wikidata.tokens import make_token_counter
