...
export interface KanbanBoardBlockOutgoingLinksByLinkEntityTypeId {}
 ...
 */
export interface KanbanBoardBlockProperties {
 ...
 */
export interface KanbanBoardCardPropertyValue {
 ...
 */
export interface KanbanBoardColumnPropertyValue {
