 ...
 * @see https://alpha.hash.ai/@luisbett/types/entity-type/address-block/v/7 for the root JSON Schema these types were generated from
...
export type AddressBlockLinksByLinkTypeId = {
  ...
  "https://alpha.hash.ai/@luisbett/types/entity-type/image-link/v/1": AddressBlockImageLinkLinks;
};
