...
export interface HasRepresentativeShuffleBlockItemOutgoingLinksByLinkEntityTypeId {}
...
export interface HasRepresentativeShuffleBlockItemProperties2 {}
...
export interface ShuffleBlockHasRepresentativeShuffleBlockItemLink {
 ...
 */
export interface ShuffleBlockItemPropertyValue {
...
export interface ShuffleBlockOutgoingLinksByLinkEntityTypeId {
 ...
 */
export interface ShuffleBlockProperties {
  /**
   * @minItems 0
   */
