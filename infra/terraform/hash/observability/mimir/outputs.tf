# Mimir service outputs for Service Connect integration

output "http_port" {
  description = "HTTP API port for Mimir metrics ingestion and queries"
...
output "grpc_port" {
  description = "gRPC API port for Mimir internal communication"
...
output "grpc_dns" {
  description = "Service Connect DNS name for gRPC API (for internal communication)"
