    ...
    policy = jsonencode({
      ...
      Statement = [
        ...
        },
        {
          ...
          Resource = "${var.config_bucket.arn}/mimir/*"
        }
      ]
    })
  }
      ...
      Statement = [
        {
          ...
          Resource = aws_s3_bucket.mimir_blocks.arn
        },
        {
          Effect = "Allow"
          Action = [
      ...
      Statement = [
        {
          ...
          Resource = aws_s3_bucket.mimir_alertmanager.arn
        },
        {
          Effect = "Allow"
          Action = [
      ...
      Statement = [
        {
          ...
          Resource = aws_s3_bucket.mimir_ruler.arn
        },
        {
          Effect = "Allow"
          Action = [
