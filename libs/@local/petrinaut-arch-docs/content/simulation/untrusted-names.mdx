...
<Sequence
  ...
  rows={[
    ...
    { phase: "Scenario code-mode return value" },
    {
      ...
      note: "The HIR interpreter builds the record without a prototype; unknown place names are type errors",
    },
  ]}
/>
...
for the place visualizer, the one surface executed as raw JavaScript.
