...
class PetrinautSession:
    ...
    def from_model_file(
        ...
        # The base class explicitly: a subclass serving a manifest has its own
        # constructor, and routing through `cls` would reach it with no source.
    ...
    @classmethod
    def from_model(cls, model: Mapping[str, Any], **options: Any) -> PetrinautSession:
