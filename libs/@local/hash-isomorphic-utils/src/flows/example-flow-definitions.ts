    ...
    },
    {
      ...
      inputSources: [
        ...
        },
        {
          ...
          kind: "step-output",
          sourceStepId: "3",
          sourceStepOutputName: "answer" satisfies OutputNameForAiFlowAction<"answerQuestion">,
        },
      ],
    },
  ],
...
export const ftseInvestorsFlowDefinition: FlowDefinition<AiFlowActionDefinitionId> = {
  ...
  description: "Research the FTSE350 index, its constituents, and the top investors in the index",
  trigger: {
    triggerDefinitionId: "userTrigger",
    description:
  ...
  steps: [
    ...
    },
    {
      ...
      steps: [
        {
          ...
          kind: "action",
          actionDefinitionId: "researchEntities",
          description: "Research investors and investments in a FTSE350 company",
          inputSources: [
            {
              inputName: "prompt" satisfies InputNameForAiFlowAction<"researchEntities">,
              kind: "hardcoded",
            ...
            {
              inputName: "existingEntities" satisfies InputNameForAiFlowAction<"researchEntities">,
        ...
        },
        {
          ...
          groupId: 2,
          kind: "action",
          description: "Save discovered FTSE350 investors and their investments to HASH graph",
          actionDefinitionId: "persistEntities",
          inputSources: [
            {
              inputName: "proposedEntities" satisfies InputNameForAiFlowAction<"persistEntities">,
      ...
      aggregateOutput: {
        stepId: "3.2",
        stepOutputName: "persistedEntities" satisfies OutputNameForAiFlowAction<"persistEntities">,
        required: true,
    ...
    },
    {
      ...
      kind: "action",
      actionDefinitionId: "answerQuestion",
      description: "Calculate the top 10 investors in the FTSE350 by market cap",
      inputSources: [
        {
          inputName: "question" satisfies InputNameForAiFlowAction<"answerQuestion">,
          kind: "step-output",
...
export const inferUserEntitiesFromWebPageFlowDefinition: FlowDefinition<AiFlowActionDefinitionId> =
  {
    ...
    description: "Infer entities from a web page, based on the user's provided entity types",
    trigger: {
      kind: "trigger",
    ...
    steps: [
      {
        ...
        inputSources: [
          {
            inputName: "url" satisfies InputNameForAiFlowAction<"getWebPageByUrl">,
            kind: "step-output",
            sourceStepId: "trigger",
        ...
        inputSources: [
          {
            ...
            kind: "step-output",
            sourceStepId: "0",
            sourceStepOutputName: "webPage" satisfies OutputNameForAiFlowAction<"getWebPageByUrl">,
          },
          {
            inputName:
  ...
  steps: [
    {
      ...
      inputSources: [
        ...
        {
          inputName: "context" satisfies InputNameForAiFlowAction<"answerQuestion">,
          kind: "step-output",
          sourceStepId: "trigger",
  ...
  steps: [
    {
      ...
      description: "Retrieve file from URL, mirror into HASH and create associated entity",
      inputSources: [
        {
        ...
        {
          inputName: "description" satisfies InputNameForAiFlowAction<"getFileFromUrl">,
          kind: "step-output",
          sourceStepId: "trigger",
          sourceStepOutputName: "description",
        },
        {
          inputName: "displayName" satisfies InputNameForAiFlowAction<"getFileFromUrl">,
          kind: "step-output",
          sourceStepId: "trigger",
