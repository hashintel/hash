...
export const manualBrowserInferenceFlowDefinition: FlowDefinition<AiFlowActionDefinitionId> = {
  ...
  trigger: {
    ...
    outputs: [
      {
        payloadKind: "WebPage" satisfies ManualInferenceTriggerInputs["visitedWebPage"]["kind"],
      ...
      {
        payloadKind: "VersionedUrl" satisfies ManualInferenceTriggerInputs["entityTypeIds"]["kind"],
      ...
      {
        payloadKind: "Text" satisfies ManualInferenceTriggerInputs["model"]["kind"],
      ...
      {
        payloadKind: "Boolean" satisfies ManualInferenceTriggerInputs["draft"]["kind"],
  ...
  steps: [
    {
      ...
      inputSources: [
        {
          inputName: "content" satisfies InputNameForAiFlowAction<"inferEntitiesFromContent">,
          kind: "step-output",
          sourceStepId: "trigger",
          sourceStepOutputName: "visitedWebPage" satisfies ManualInferenceTriggerInputName,
        },
        {
          inputName: "entityTypeIds" satisfies InputNameForAiFlowAction<"inferEntitiesFromContent">,
          kind: "step-output",
          sourceStepId: "trigger",
          sourceStepOutputName: "entityTypeIds" satisfies ManualInferenceTriggerInputName,
        },
        {
          inputName: "model" satisfies InputNameForAiFlowAction<"inferEntitiesFromContent">,
          kind: "step-output",
          sourceStepId: "trigger",
          sourceStepOutputName: "model" satisfies ManualInferenceTriggerInputName,
        },
      ],
    },
    {
      ...
      inputSources: [
        ...
        },
        {
          ...
          kind: "step-output",
          sourceStepId: "trigger",
          sourceStepOutputName: "draft" satisfies ManualInferenceTriggerInputName,
        },
      ],
    },
  ],
...
export const automaticBrowserInferenceFlowDefinition: FlowDefinition<AiFlowActionDefinitionId> = {
  ...
  description: "Find entities in a web page according to the user's passive analysis settings",
  trigger: {
    kind: "trigger",
    ...
    outputs: [
      {
        payloadKind: "WebPage" satisfies AutomaticInferenceTriggerInputs["visitedWebPage"]["kind"],
        description: "The web page visited",
  ...
  steps: [
    {
      ...
      description: "Decide which types of entity to find given the web page visited",
      inputSources: [
        {
          inputName:
          ...
          kind: "step-output",
          sourceStepId: "trigger",
          sourceStepOutputName: "visitedWebPage" satisfies AutomaticInferenceTriggerInputName,
        },
      ],
    },
    {
