...
export const historicalFlightsFlowDefinition: FlowDefinition<IntegrationFlowActionDefinitionId> = {
  ...
  description: "Fetch and save historical flight arrivals for an airport over a date range.",
  trigger: {
  ...
  steps: [
    {
      ...
      description: "Fetch historical flight arrivals for the specified airport and date range",
      inputSources: [
        {
          inputName:
...
export const scheduledFlightsFlowDefinition: FlowDefinition<IntegrationFlowActionDefinitionId> = {
  ...
  trigger: {
    triggerDefinitionId: "userTrigger",
    description: "User provides an airport ICAO code and date to fetch scheduled flights for",
    kind: "trigger",
    outputs: [
      {
        payloadKind: "Text",
  ...
  steps: [
    {
      ...
      description: "Fetch scheduled flight arrivals from for the specified airport and date",
      inputSources: [
        {
          inputName:
        ...
        {
          inputName: "date" satisfies InputNameForIntegrationFlowAction<"getScheduledFlights">,
          kind: "step-output",
          sourceStepId: "trigger",
