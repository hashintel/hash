export const systemTypes = {
  entityType: {
    ...
    hashInstance: {
      ...
      entityTypeBaseUrl:
        "https://hash.ai/@hash/types/entity-type/hash-instance/",
    },
    image: {
    ...
    notification: {
      ...
      entityTypeBaseUrl:
        "https://hash.ai/@hash/types/entity-type/notification/",
    },
    organization: {
      entityTypeId: "https://hash.ai/@hash/types/entity-type/organization/v/1",
      entityTypeBaseUrl:
        "https://hash.ai/@hash/types/entity-type/organization/",
    },
    page: {
  ...
  linkEntityType: {
    ...
    hasData: {
      ...
      linkEntityTypeBaseUrl:
        "https://hash.ai/@hash/types/entity-type/has-data/",
    },
    hasIndexedContent: {
      linkEntityTypeId:
    ...
    hasText: {
      ...
      linkEntityTypeBaseUrl:
        "https://hash.ai/@hash/types/entity-type/has-text/",
    },
    isMemberOf: {
      linkEntityTypeId:
