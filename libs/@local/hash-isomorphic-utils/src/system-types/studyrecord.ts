...
export type HasContact = {
  entityTypeIds: [
    "https://hash.ai/@h/types/entity-type/has-contact/v/1" & VersionedUrl,
  ];
...
export type ISRCTNDataTypeMetadata = {
  provenance?: PropertyProvenance;
  confidence?: Confidence;
  dataTypeId: "https://hash.ai/@h/types/data-type/isrctn/v/1" & VersionedUrl;
};
...
export type InvestigatedBy = {
  entityTypeIds: [
    "https://hash.ai/@h/types/entity-type/investigated-by/v/1" & VersionedUrl,
  ];
...
export type NCTIDDataTypeMetadata = {
  provenance?: PropertyProvenance;
  confidence?: Confidence;
  dataTypeId: "https://hash.ai/@h/types/data-type/nct-id/v/1" & VersionedUrl;
};
...
export type SponsoredBy = {
  entityTypeIds: [
    "https://hash.ai/@h/types/entity-type/sponsored-by/v/1" & VersionedUrl,
  ];
...
export type StudyRecord = {
  entityTypeIds: [
    "https://hash.ai/@h/types/entity-type/study-record/v/1" & VersionedUrl,
  ];
