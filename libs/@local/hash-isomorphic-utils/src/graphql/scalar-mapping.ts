export const scalars = {
  ...
  QueryDataTypesResponse: "@local/hash-graph-sdk/data-type#QueryDataTypesResponse",
  QueryDataTypeSubgraphParams: "@local/hash-graph-sdk/data-type#QueryDataTypeSubgraphParams",
  QueryDataTypeSubgraphResponse:
    "@local/hash-graph-sdk/data-type#SerializedQueryDataTypeSubgraphResponse",
  ConstructDataTypeParams: "@local/hash-graph-sdk/ontology#ConstructDataTypeParams",
  DataTypeFullConversionTargetsMap:
    "@local/hash-graph-sdk/ontology#DataTypeFullConversionTargetsMap",
  DataTypeDirectConversionsMap: "@local/hash-graph-sdk/ontology#DataTypeDirectConversionsMap",

  ClosedMultiEntityType: "@blockprotocol/type-system#ClosedMultiEntityType",
  ClosedMultiEntityTypesRootMap: "@local/hash-graph-sdk/ontology#ClosedMultiEntityTypesRootMap",
  ...
  QueryEntityTypesParams: "@local/hash-graph-sdk/entity-type#QueryEntityTypesParams",
  QueryEntityTypesResponse: "@local/hash-graph-sdk/entity-type#QueryEntityTypesResponse",
  QueryEntityTypeSubgraphParams: "@local/hash-graph-sdk/entity-type#QueryEntityTypeSubgraphParams",
  ...
  ConstructEntityTypeParams: "@local/hash-graph-sdk/ontology#ConstructEntityTypeParams",

  PropertyTypeWithMetadata: "@blockprotocol/type-system#PropertyTypeWithMetadata",
  QueryPropertyTypesParams: "@local/hash-graph-sdk/property-type#QueryPropertyTypesParams",
  QueryPropertyTypesResponse: "@local/hash-graph-sdk/property-type#QueryPropertyTypesResponse",
  ...
  ConstructPropertyTypeParams: "@local/hash-graph-sdk/ontology#ConstructPropertyTypeParams",
  ...
  EntityValidationReport: "@local/hash-graph-sdk/validation#EntityValidationReport",
  ...
  QueryEntitiesResponse: "@local/hash-graph-sdk/entity#SerializedQueryEntitiesResponse",
  QueryEntitySubgraphRequest: "@local/hash-graph-sdk/entity#QueryEntitySubgraphRequest",
  QueryEntitySubgraphResponse: "@local/hash-graph-sdk/entity#SerializedQueryEntitySubgraphResponse",
  ...
  PropertyObjectWithMetadata: "@blockprotocol/type-system#PropertyObjectWithMetadata",
  ...
  ValidateEntityParamsComponents: "@local/hash-graph-client#ValidateEntityParamsComponents",
  EntityQueryCursor: "@local/hash-graph-client#EntityQueryCursor",
  CreatedByIdsMap: "@local/hash-graph-sdk/entity#CreatedByIdsMap",
  TypeIdsAndPropertiesForEntity: "@blockprotocol/type-system#TypeIdsAndPropertiesForEntity",
  ...
  AggregatedUsageRecord: "@local/hash-isomorphic-utils/service-usage#AggregatedUsageRecord",

  UserPermissionsOnEntities: "@local/hash-graph-sdk/authorization#UserPermissionsOnEntities",
  ...
  UserPermissionsOnEntityType: "@local/hash-graph-sdk/authorization#UserPermissionsOnEntityType",
  UserPermissionsOnDataType: "@local/hash-graph-sdk/authorization#UserPermissionsOnDataType",
  ...
  AuthorizationSubjectId: "@local/hash-graph-sdk/authorization#AuthorizationSubjectId",
  ...
  FlowTypeDataType: "@local/hash-isomorphic-utils/system-types/shared#FlowTypeDataType",
  FlowActionDefinitionId: "@local/hash-isomorphic-utils/flows/types#FlowActionDefinitionId",
  FlowDataSources: "@local/hash-isomorphic-utils/flows/types#FlowDataSources",
  FlowDefinition: "@local/hash-isomorphic-utils/flows/types#FlowDefinition<FlowActionDefinitionId>",
  FlowInputs: "@local/hash-isomorphic-utils/flows/types#FlowInputs",
  ScheduleSpec: "@local/hash-isomorphic-utils/flows/schedule-types#ScheduleSpec",
  ...
  ExternalInputRequest: "@local/hash-isomorphic-utils/flows/types#ExternalInputRequest",
  ...
  ResolvedStepRunOutput: "@local/hash-isomorphic-utils/flows/types#ResolvedStepRunOutput",
