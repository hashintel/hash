...
export const ExternalServicePriceNameEnum = {
  OpenAiGpt4InputToken: "OpenAI GPT-4 Input Token",
  OpenAiGpt4OutputToken: "OpenAI GPT-4 Output Token",
 ...
 *
 * @export
 * @interface GetExternalServiceUsage200Response
 */
export interface GetExternalServiceUsage200Response {
  /**
   *
   * @type {Array<GetExternalServiceUsage200ResponseExternalServiceUsageInner>}
   * @memberof GetExternalServiceUsage200Response
   */
  externalServiceUsage: Array<GetExternalServiceUsage200ResponseExternalServiceUsageInner>;
}
/**
 *
 * @export
 * @interface GetExternalServiceUsage200ResponseExternalServiceUsageInner
 */
export interface GetExternalServiceUsage200ResponseExternalServiceUsageInner {
  /**
   *
   * @type {string}
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInner
   */
  name: string;
  /**
   *
   ...
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInner
   */
  providerName: GetExternalServiceUsage200ResponseExternalServiceUsageInnerProviderNameEnum;
  /**
   *
   * @type {string}
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInner
   ...
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInner
   */
  usageCalculationMethod?: GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsageCalculationMethodEnum;
  /**
   *
   * @type {string}
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInner
  ...
  /**
   *
   * @type {Array<GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsagePerPriceInner>}
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInner
   */
...
export const GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsageCalculationMethodEnum =
  {
    PerRequest: "per-request",
    DetermineAfterRequest: "determine-after-request",
    PerSession: "per-session",
  } as const;

export type GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsageCalculationMethodEnum =
  (typeof GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsageCalculationMethodEnum)[keyof typeof GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsageCalculationMethodEnum];

/**
 *
 * @export
 * @interface GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsagePerPriceInner
 */
export interface GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsagePerPriceInner {
  /**
   *
   * @type {string}
   * @memberof GetExternalServiceUsage200ResponseExternalServiceUsageInnerUsagePerPriceInner
   */
...
export interface GetWebSearchResults200Response {
  /**
   *
   * @type {Array<GetWebSearchResults200ResponseWebSearchResultsInner>}
   * @memberof GetWebSearchResults200Response
   */
  webSearchResults: Array<GetWebSearchResults200ResponseWebSearchResultsInner>;
}
/**
 *
 * @export
 * @interface GetWebSearchResults200ResponseWebSearchResultsInner
 */
export interface GetWebSearchResults200ResponseWebSearchResultsInner {
  /**
   *
   * @type {string}
   * @memberof GetWebSearchResults200ResponseWebSearchResultsInner
   */
  title: string;
  /**
   *
...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
    ...
    /**
     *
     * @summary Retrieve the external service usage of a user
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
     ...
     * @throws {RequiredError}
     */
    getWebSearchResults: async (
      query: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'query' is not null or undefined
      assertParamExists("getWebSearchResults", "query", query);
      const localVarPath = `/web-search-results`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    getWebSearchResults(
      ...
      return localVarFp
        .getWebSearchResults(query, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class DefaultApi extends BaseAPI implements DefaultApiInterface {
   ...
   * @memberof DefaultApi
   */
  public getExternalServiceUsage(options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .getExternalServiceUsage(options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public getWebSearchResults(query: string, options?: AxiosRequestConfig) {
    return DefaultApiFp(this.configuration)
      .getWebSearchResults(query, options)
      .then((request) => request(this.axios, this.basePath));
  }
