// Required to detect types defined by this crate as we don't use the crate in this binray
// otherwise and the linker would optimize it out.
extern crate hash_codec;
