...
use crate::harpc::{
    ...
    transport::codec::{decode::DecodeBinary, encode::EncodeBinary},
};
...
#[cfg(test)]
mod test {
    use crate::harpc::transport::{codec::test::assert_binary, message::version::TransportVersion};
    assert_binary![binary_transport_version(
        TransportVersion::new(0xFE),
        &[0xFE]
    )];
}
