...
impl ErrorCode {
    ...
    pub const TRANSACTION_LAGGING: Self = Self(NonZero::new(0xFF_E1).expect("infallible"));
    pub const TRANSACTION_LIMIT_REACHED: Self = Self(NonZero::new(0xFF_E2).expect("infallible"));
