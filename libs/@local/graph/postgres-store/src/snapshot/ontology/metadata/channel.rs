...
use hash_graph_types::ontology::{OntologyProvenance, OntologyTemporalMetadata};
use type_system::{
    ontology::provenance::OntologyOwnership, schema::OntologyTypeUuid, url::OntologyTypeRecordId,
};
