...
mod tests {
    ...
    fn transpile_entity_id_rows() {
        assert_eq!(
            ...
            r#"INSERT INTO "entity_ids" ("web_id", "entity_uuid", "provenance", "read_only", "created_by_id") SELECT * FROM UNNEST(($1::uuid[]), ($2::uuid[]), ($3::jsonb[]), ($4::bool[]), ($5::uuid[]))"#
        );
    }
    ...
    fn transpile_snapshot_options() {
        assert_eq!(
            ...
            r#"INSERT INTO "entity_ids_tmp" ("web_id", "entity_uuid", "provenance", "read_only", "created_by_id") SELECT DISTINCT * FROM UNNEST(($1::uuid[]), ($2::uuid[]), ($3::jsonb[]), ($4::bool[]), ($5::uuid[])) ON CONFLICT DO NOTHING"#
        );
    }
}
