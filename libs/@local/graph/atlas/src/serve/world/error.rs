//! The failures a [`World`](super::World) can report while opening.
//!
//! Each component's open reports its artifact and count refusals under this one type, and the
//! world adds the agreement it checks across components.
