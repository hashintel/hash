...
/// Limits on requested types, incident edges and per-source and per-link detail.
...
/// Ontology selection, limits and a live-detail resolver for one locate request.
...
/// A failure to assemble a locate document.
#[derive(Debug)]
