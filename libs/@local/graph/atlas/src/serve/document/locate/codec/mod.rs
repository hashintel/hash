...
impl LocateResponse<'_> {
    ...
    /// Encodes an optional property map.
    ///
    /// An absent map encodes as `null`, and a present one as a map of interned base-URL index to
    /// scalar value.
    ...
    /// Encodes the locate trailer map.
    ///
    /// The map holds interned type and property URLs, source labels and properties, and link
