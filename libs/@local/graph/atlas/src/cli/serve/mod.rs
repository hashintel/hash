...
impl ServeCommand {
    ...
    /// entry already past [`VisibilityLimits::soft`]. The host must run and retain the maintenance
    /// future returned by [`Serving::into_parts`] through listener failure and shutdown.
    ///
    /// # Errors
    ///
