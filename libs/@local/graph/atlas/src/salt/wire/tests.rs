...
mod tile {
    ...
    use super::{
        ...
        Depth, GlobalHead, Icon, Label, Membership, Mode, MortonTile, NodeRowId, Sha256Digest,
...
mod locate {
    ...
    use super::{
        BasePosition, DenseBitSlice, Depth, Label, LocateResponse, LocateTrailer, Membership,
        MortonTile, PropertyMap, PropertyValue, Sha256Digest, Vec2, WireRow, dense_set,
        identity_of, section,
    };
    use crate::serve::{
