...
/// The lower end of the temperature search interval.
const TEMPERATURE_MINIMUM: f64 = 0.05;
/// The upper end of the temperature search interval.
const TEMPERATURE_MAXIMUM: f64 = 20.0;
/// The golden-section iteration budget over `ln T`.
...
/// The golden-section contraction ratio `1/φ`.
