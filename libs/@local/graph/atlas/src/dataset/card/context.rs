...
/// never of an individual relation, so they travel together past every per-card input.
pub(crate) struct CardContext<S, T> {
    /// The prose language, as a BCP 47 primary language subtag.
    pub language: &'static str,
    /// The sentence segmenter dividing descriptions into a lead sentence and removable detail.
    pub segmenter: S,
