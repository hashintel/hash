...
//!
//! The measurement defaults to retired instructions and is selected with `MATH_BENCH_EVENT`, a
//! comma-separated list: every listed measurement runs the whole suite once, in list order, with
