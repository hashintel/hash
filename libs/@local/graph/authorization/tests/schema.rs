...
pub const ALICE: UntaggedActorId = UntaggedActorId::new(Uuid::from_fields(1, 0, 0, &[0; 8]));
pub const BOB: UntaggedActorId = UntaggedActorId::new(Uuid::from_fields(2, 0, 0, &[0; 8]));
