...
pub const ALICE: ActorEntityUuid = ActorEntityUuid::new(Uuid::from_fields(1, 0, 0, &[0; 8]));
pub const BOB: ActorEntityUuid = ActorEntityUuid::new(Uuid::from_fields(2, 0, 0, &[0; 8]));
