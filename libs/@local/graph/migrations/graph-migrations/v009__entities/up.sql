...
SELECT
    ...
    (array_agg(entity_label_agg.property ORDER BY entity_label_agg.property ASC))[1] AS label
...
SELECT
    entity_label_agg.entity_edition_id,
    (array_agg(entity_label_agg.property ORDER BY entity_label_agg.property DESC))[1] AS label
FROM entity_label_agg
GROUP BY entity_label_agg.entity_edition_id;
