...
pub enum FontFamily {
    ...
    /// [Fraktur](https://en.wikipedia.org/wiki/Fraktur) was common.
    /// Nowadays Fraktur is seldom used in Germany and is no longer taught or practiced in
    /// German schools and can be considered a relic of the past.
    ///
