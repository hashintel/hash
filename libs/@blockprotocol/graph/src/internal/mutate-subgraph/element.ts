 ...
 * @param dataTypes - – the data types to add to the provided subgraph.
 * @returns – the vertex IDs of the data type vertices that were added.
 */
 ...
 *
 * @param subgraph - – the subgraph to mutate by adding the provided entities.
 * @param propertyTypes - – the data types to add to the provided subgraph.
 * @returns – the vertex IDs of the property type vertices that were added.
 */
 ...
 *
 * @param subgraph - – the subgraph to mutate by adding the provided entities.
 * @param entityTypes - – the data types to add to the provided subgraph.
 * @returns – the vertex IDs of the entity type vertices that were added.
 */
 ...
 *
 * @param subgraph - – the subgraph to mutate by adding the provided entities.
 * @param entities - – the entities to add to the provided subgraph.
 * @returns – the vertex IDs of the added entities.
 */
