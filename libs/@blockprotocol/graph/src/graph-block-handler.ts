...
import type { BaseUrl, Entity, Property } from "@blockprotocol/type-system";
    ...
    >
{
  ...
  createEntity<
    ValidProperties extends Record<BaseUrl, Property> = Record<
      BaseUrl,
      Property
    >,
  ...
  queryEntities({ data }: { data?: QueryEntitiesData }) {
    return this.sendMessage<
