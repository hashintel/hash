...
//! - [`Value`]: Primitive data values like strings, numbers, booleans, etc., which form the atomic
//!   units of knowledge within properties. [`Value`]s conform to [`DataType`]s defined in the
//!   ontology.
//!
