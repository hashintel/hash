...
pub use self::{
    ...
    data_type::{
        ...
        DataTypeInheritanceData, DataTypeReference, DataTypeValidator, JsonSchemaValueType,
        NullTypeTag, NumberConstraints, NumberSchema, NumberTypeTag, NumberValidationError,
        ObjectTypeTag, OntologyTypeResolver, Operator, SingleValueConstraints, SingleValueSchema,
        StringConstraints, StringFormat, StringFormatError, StringSchema, StringTypeTag,
        StringValidationError, TupleConstraints, ValidateDataTypeError, ValueLabel, Variable,
    },
    entity_type::{
