...
export { faCalendarClockRegular } from "./fa-calendar-clock-regular";
export { faCalendarRegular } from "./fa-calendar-regular";
export { faCheck } from "./fa-check";
export { faCirclePlus } from "./fa-circle-plus";
export { faClockRegular } from "./fa-clock-regular";
