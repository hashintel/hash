import type { MultiFilter, MultiFilterOperatorType } from "@blockprotocol/graph";
...
type PropertyOperatorWithValue = "is" | "is not" | "contains" | "does not contain";

export type PropertyOperator = PropertyOperatorWithoutValue | PropertyOperatorWithValue;
...
export type PropertyFilter = PropertyFilterWithValue | PropertyFilterWithoutValue;
