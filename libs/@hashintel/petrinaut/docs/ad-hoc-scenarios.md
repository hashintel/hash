...
- **Parameters** -- one row per [net-level parameter](petri-net-extensions.md#global-parameters), showing its type and its default. Enter an expression to override a value for this run -- it may read the Variables above.
