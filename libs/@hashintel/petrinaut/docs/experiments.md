...
selected scenario parameters to improve one objective metric. A parameter sweep
bridges the two: its **Optimize** button searches the swept intervals with the
in-browser optimizer, through the sweep's own compute.
