...
Adds a **Notebook** option to the mode selector in the top bar: a read-only view of the net as a list of cells, for reviewing and debugging models. See [Notebook View](notebook-view.md).
