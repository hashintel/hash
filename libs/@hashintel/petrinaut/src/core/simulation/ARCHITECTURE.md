...
time is owned by the run controller and attached only when creating worker
payloads/readers. Future binary work should happen behind the worker payload and
