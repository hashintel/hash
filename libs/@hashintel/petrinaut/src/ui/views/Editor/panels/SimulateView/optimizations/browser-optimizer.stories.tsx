...
const watchForNote =
  "Watch the Parameters band follow each step, the Surface gain a ring per step with the best emphasized, and the Metrics tile stream the objective over the step's runs. Once complete, click the Surface or move a slider: the point refines in escalating batches and the Metrics tile streams again.";
