 ...
 * rather than pushing it aside. Each node sets its own row height, since a
 * transition has less of it to give than a circle, and two classes setting
 * one property would leave the winner to Panda's ordering.
 */
