...
import { useComponentInstanceStatus } from "../../../canvas-frame-store";
...
> = ({ id, data, selected }: NodeProps<ComponentInstanceNodeType>) => {
  ...
  // A frame re-renders this instance only when its own status labels move.
  const statusSummary = useComponentInstanceStatus(id);
  ...
  return (
    <div className={containerStyle}>
      ...
      <div
        className={`${cardStyle} ${nodeFocusStyle({ focus })}`}
