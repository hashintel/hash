 ...
 * container that registers as a member of the enclosing worksheet stack,
 * and the table with the form's fixed layout. The rows inside stay the
 * owning table's business.
 *
