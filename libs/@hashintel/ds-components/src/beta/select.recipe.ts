...
const selectSlotRecipeDefinition = {
  className: "select",
...
export const selectSlotRecipe = sva(selectSlotRecipeDefinition);

export type SelectSlotRecipeProps = RecipeVariantProps<typeof selectSlotRecipe>;
