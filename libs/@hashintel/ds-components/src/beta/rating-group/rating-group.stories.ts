export default { title: "Primitives/RatingGroup" };

export { App as basic } from "./basic.story";
export { App as colors } from "./colors.story";
export { App as controlled } from "./controlled.story";
export { App as customIcon } from "./custom-icon.story";
export { App as half } from "./half.story";
export { App as label } from "./label.story";
export { App as readOnly } from "./read-only.story";
