...
const tableSlotRecipeDefinition = {
  className: "table",
...
export const tableSlotRecipe = sva(tableSlotRecipeDefinition);

export type TableSlotRecipeProps = RecipeVariantProps<typeof tableSlotRecipe>;
