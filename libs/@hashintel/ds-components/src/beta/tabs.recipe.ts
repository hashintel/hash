...
const tabsSlotRecipeDefinition = {
...
export const tabsSlotRecipe = sva(tabsSlotRecipeDefinition);

export type TabsSlotRecipeProps = RecipeVariantProps<typeof tabsSlotRecipe>;
