...
/* eslint-disable import/no-extraneous-dependencies, @typescript-eslint/no-shadow, @typescript-eslint/no-empty-object-type */
...
import { fileUpload } from "@hashintel/ds-helpers/recipes";
