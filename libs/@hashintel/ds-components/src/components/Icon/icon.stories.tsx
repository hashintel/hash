...
export const Default: Story<React.ComponentProps<typeof Icon>> = (args) => <Icon {...args} />;
...
export const AllIcons: Story<React.ComponentProps<typeof Icon>> = (args) => iconGrid(args);
AllIcons.parameters = {
