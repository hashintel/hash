...
const pilotConfigs = new Map<string, PilotConfig>([
  ...
  ["avatar", { name: "avatar", suppressRecipeTypeErrors: true }],
  ...
  ["carousel", { name: "carousel", suppressRecipeTypeErrors: true }],
  ["checkbox", { name: "checkbox", suppressRecipeTypeErrors: true }],
  ["clipboard", { name: "clipboard", suppressRecipeTypeErrors: true }],
  ["combobox", { name: "combobox", suppressRecipeTypeErrors: true }],
  ["collapsible", { name: "collapsible", suppressRecipeTypeErrors: false }],
  ["color-picker", { name: "color-picker", suppressRecipeTypeErrors: true }],
  ["code", { name: "code", suppressRecipeTypeErrors: true }],
  ["date-picker", { name: "date-picker", suppressRecipeTypeErrors: true }],
  ["dialog", { name: "dialog", suppressRecipeTypeErrors: true }],
  ["editable", { name: "editable", suppressRecipeTypeErrors: true }],
  ["field", { name: "field", suppressRecipeTypeErrors: true }],
  ["fieldset", { name: "fieldset", suppressRecipeTypeErrors: true }],
  ["group", { name: "group", suppressRecipeTypeErrors: true }],
  ["heading", { name: "heading", suppressRecipeTypeErrors: false }],
  ["hover-card", { name: "hover-card", suppressRecipeTypeErrors: true }],
  ["icon", { name: "icon", suppressRecipeTypeErrors: true }],
  ["input-addon", { name: "input-addon", suppressRecipeTypeErrors: true }],
  ["input-group", { name: "input-group", suppressRecipeTypeErrors: true }],
  ...
  ["file-upload", { name: "file-upload", suppressRecipeTypeErrors: true }],
  ["menu", { name: "menu", suppressRecipeTypeErrors: true }],
  ["number-input", { name: "number-input", suppressRecipeTypeErrors: true }],
  ...
  ["segment-group", { name: "segment-group", suppressRecipeTypeErrors: true }],
  ["select", { name: "select", suppressRecipeTypeErrors: true }],
  ["slider", { name: "slider", suppressRecipeTypeErrors: true }],
  ...
  ["tabs", { name: "tabs", suppressRecipeTypeErrors: true }],
