...
The only non-contractual part of the B2 verdict is the exact guarantee that the _public message
projection_ remains byte-for-byte stable across compaction. Public docs promise an append-only
