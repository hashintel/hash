...
Keep the cumulative v1-plus-v2 currency ceiling at $10 USD rather than granting a second $10 allowance. Recompute the v2 estimate, bind the exact objective in the v2 instrument manifest, pass a regression check that rejects evaluator-owned category terms in that objective, and obtain fresh owner acceptance of the v2 manifest and remaining spend before any v2 model call.
