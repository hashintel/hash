...
Keep the cumulative v1-plus-v2 currency ceiling at $10 USD rather than granting a second $10 allowance. Recompute the v2 estimate, bind the complete exact objective in the v2 instrument manifest and a SHA-256 regression check, and obtain fresh owner acceptance of the v2 manifest and remaining spend before any v2 model call. Missing v1 Sonnet usage must be reconciled from organization billing rather than replaced by an unexplained reserve or treated as zero.
