...
- [`MISSION.md`](../../MISSION.md) — sole execution authority and the current Mission 4 workpiece decisions.
...
- Deployment branch `ln/fe-1569-brunch-agent-deployment`, especially `libs/@hashintel/brunch-agent/docs/evidence/implementations/mission-8-deployment-handoff.md` — local application contract and the still-open infrastructure proof that any deployed durability claim must consume.
