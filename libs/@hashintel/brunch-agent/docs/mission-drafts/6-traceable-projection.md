...
- [`../../packages/plugin-sdcpn/src/skills/sdcpn-modelling/SKILL.md`](../../packages/plugin-sdcpn/src/skills/sdcpn-modelling/SKILL.md), its construction/check resources, and the exact accepted Mission 4 candidate versions — target-formalism guidance and current workpiece contract. Do not treat historical branch-tip resources as the frozen Mission 4 instrument.
- Deployment branch `ln/fe-1569-brunch-agent-deployment`, read with `git show`: current `MISSION.md`, handoff evidence, application persistence/telemetry files, and open infrastructure gates. Mission 6 consumes the actual deployed contract inherited through Mission 5; it must not imply the branch achieved remote deployment.
