...
interpretation-render panel** — the display surface through which the audience _sees_ (a) and
...
FE-1359's tiers). Note: even the _prospect_ of voice argues for the demo-shell topology —
...
3. **Standing preference**: decoupling unless evidence forces coupling — no evidence does; the
   demo-legibility test _favors_ the boundary (the handoff is a beat, not a seam to hide).
