> **Superseded 2026-08-25.** Archive copy of `docs/specs/plugin-contract.md` as it stood before
> [ADR-0006](../../adr/0006-plugins-per-target-formalism.md) (plugins are per target formalism,
...
> and the exemplar [`sdcpn-plugin.md`](../../specs/sdcpn-plugin.md). Content is otherwise
...
provisional [target-document completion contract](elicitation-completion-2026-08-25-full-draft.md).
...
- The provisional CPS technique-card IDs and clarification fragments are now defined in the
  [FE-1403 CPS interview guidance](cps-interview-guidance-2026-08-25.md). Its desk replay is design evidence,
