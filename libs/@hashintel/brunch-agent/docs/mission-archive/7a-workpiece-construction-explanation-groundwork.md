...
> Archived when Mission 7b was cut from `2408b90bac` on 2026-09-10. Part A later landed on `main` as [PR #9562](https://github.com/hashintel/hash/pull/9562). [Mission 7b](7b-ordinary-batched-construction-provenance.md) is archived on the Mission 7c child branch. The substantial product successor described below now belongs to live [Mission 7c](../../MISSION.md); this archive otherwise preserves the boundary as understood when 7a closed.

## Status

**Engineering boundary archived for PR closeout; not a demo or semantic-quality acceptance.** Lu directed a split: this branch and [PR #9562](https://github.com/hashintel/hash/pull/9562) carry the mechanical groundwork; Mission 7b continued under the same FE-1573 issue on a child branch and has since been archived at the 7c cut. The former full-region/100%-useful-explanation campaign was not a prerequisite to this engineering split, but the split did not authorize a narrow scripted demo. The broad flagship obligation originally allocated to 7b now belongs to live [Mission 7c](../../MISSION.md). The broader cross-scenario, passage/lifecycle and adversarial evaluation portfolio remains in the [after-demo evaluation draft](../mission-drafts/7-explainable-construction.md).
...
- [Mission 7c](../../MISSION.md): substantial Postgres-seeded Inventory worked model, PM exploration/correction, broad flagship explanation coverage, persona-driven construction recording, selected-model tool/dynamics/compiler/layout needs and necessary delivery joins.
