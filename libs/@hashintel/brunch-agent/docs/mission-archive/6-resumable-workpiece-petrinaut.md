...
- **Outer:** the two-tab `yarn dev:brunch` witness above, with retained before/after artifacts, one Voice-origin message, and one durably stopped assistant turn. A content-only transcript match does not establish faithful resume.
