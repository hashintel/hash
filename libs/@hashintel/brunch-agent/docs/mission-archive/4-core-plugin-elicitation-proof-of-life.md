...
5. **Content basis.** Ampcode is the conceptual basis ([design evidence](../evidence/design/mission-4-prompt-skill-tool-architecture.md)); Five-Register supplies the domain-primary workpiece template and the evidence-level checks. No third synthesis. Registers classify what guidance does; they are not phases, question order, schemas, or file topology.
