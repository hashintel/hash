...
([flue-architecture-cheatsheet](../reference/architecture/flue-architecture-cheatsheet.md)) sorted this
...
The topology verification ([topology.md](../reference/architecture/topology.md)) then walked the actual tree
...
[topology.md](../reference/architecture/topology.md), are ratified. In brief:
