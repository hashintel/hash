...
These ADRs record design decisions accepted under the prior process. They are now **hypotheses,
not obligations**: unimplemented design is not a roadmap, and a branch may depart from any of
these by noting the divergence in its commit. Implemented decisions are evidence, not authority —
re-earn before building further on them.
