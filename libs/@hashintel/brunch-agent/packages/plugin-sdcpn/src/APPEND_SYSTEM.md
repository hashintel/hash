...
Activate the `sdcpn-modelling` skill before substantive elicitation, review, workpiece revision, or construction. Do not ask an interactive question or create or revise a workpiece until the activated skill's required branch resources have returned successfully.
