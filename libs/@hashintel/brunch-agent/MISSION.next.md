...
> Canonical future-planning spine, shared frame and backlog index only; not execution authority. [`MISSION.md`](MISSION.md) is the sole live authority for Mission 7c's Inventory worked-model, compiler, layout, why-routing, tool-topology and Postgres-copy work under FE-1573, partially addressing FE-1478 without closing it. [Mission 7a](docs/mission-archive/7a-workpiece-construction-explanation-groundwork.md) has landed on `main` as [#9562](https://github.com/hashintel/hash/pull/9562). [Mission 7b](docs/mission-archive/7b-ordinary-batched-construction-provenance.md) is archived on this child branch while its engineering PR [#9649](https://github.com/hashintel/hash/pull/9649) completes external review. The consumed 7c draft is retrievable at `d1906da697:libs/@hashintel/brunch-agent/docs/mission-drafts/7c-inventory-worked-model.md`. The former Step B programme remains [after-demo evaluation](docs/mission-drafts/7-explainable-construction.md). Older sequencing and deployment assertions below are historical planning inputs, not current execution or environment facts.

This spine, the live Mission 7c contract, the archived 7a/7b contracts, the after-demo evaluation draft and three broader successor drafts form one planning record. The Voice reconciliation draft has been consumed into Mission 6b's parent-branch authority, not retained as competing planning authority. Keep each consequential meaning in one authoritative home: shared future constraints and unallocated concerns live here; future mission-specific detail lives in its packet or draft; live Mission 7 contracts live only in root authority. A spine pointer is not a second contract. Material omitted from a cut returns to this record at full fidelity, and consumed draft content is removed.
...
**Current scope:** [Mission 7c](MISSION.md) owns the Inventory-comparable connected model, provider-tested operation admission, compiler feedback and repair, ELK layout, reliable mechanical why routing, tool catalogue/naming/homing topology, Postgres-backed bundle templates and independently owned copies. [Mission 7b](docs/mission-archive/7b-ordinary-batched-construction-provenance.md) remains the accepted ordinary structural batch/correction/reopen seam and is not reopened here. Petrinaut simulation scenarios/metrics and a second worked-model bundle remain outside by default pending PM confirmation.
...
M7a  landed on main as #9562 — workpiece/construction/why groundwork
M7b  FE-1573 engineering PR #9649 — ordinary batched structural construction, correction, recorded basis/effects, reopen, and experimental create-new entry; external review/merge pending
M7c  FE-1573 explicit third-PR exception, partial FE-1478 — live Inventory worked-model, compiler/layout/why/tool-topology/Postgres-copy work
...
The archived [Mission 7b](docs/mission-archive/7b-ordinary-batched-construction-provenance.md) owns the accepted ordered structural mutation carrier, one ordinary small-net construction/correction/reopen path and the gated create-new affordance. Live [Mission 7c](MISSION.md) owns the Inventory-comparable connected model, provider-tested operation admission, compiler feedback and repair, ELK layout, reliable mechanical why routing, tool catalogue/naming/homing topology, Postgres-backed bundle templates and independently owned copies. Petrinaut simulation scenarios/metrics and a second worked-model bundle remain outside by default pending PM confirmation. The [evaluation draft](docs/mission-drafts/7-explainable-construction.md) retains broader semantic/behavioural reliability, expanded passage/adversarial/lifecycle matrices and population claims after the demo.

| Priority | Scope and authoritative home |
| --- | --- |
| Remaining 7a PR closeout | Landed on `main` as [#9562](https://github.com/hashintel/hash/pull/9562) — [archived 7a contract](docs/mission-archive/7a-workpiece-construction-explanation-groundwork.md) |
| Remaining 7b closeout | External CI/review/merge of the ordinary structural batch/correction/reopen seam and gated create-new affordance — [archived 7b contract](docs/mission-archive/7b-ordinary-batched-construction-provenance.md) and PR #9649 |
| Before September live demo | Open an owned `?bundle=inventory-purchasing` copy with retained conversation/revisions/workpiece/connected compiler-clean and legible net; inspect why/source classes; correct without unrelated rebuilding; reopen/rehearse — live Mission 7c |
| Required September recording | Realistic persona interview, recurring workpiece revisions and native substantial-net construction through the visible product, with retained real records and no hidden operator construction — live Mission 7c |
| Demo delivery | Stable bundle URL, coherent template identities, Postgres startup catalogue updates, independently continuable copies, intended host/revision/access and safe rehearsal reset — live Mission 7c and deployment section below |
...
Database-backed independent working copies are part of live Mission 7c. If executable simulation, optimisation, or accepted Chris/Yannis handoff becomes part of the demo claim, record that tier explicitly rather than implying it from the old six-beat frame. A meaningful recorded construction flow is required; Mission 7c's why/readiness obligations, not the old campaign schedule or a count alone, govern the flagship.
...
### Stable template delivery allocated to Mission 7c

Live [Mission 7c](MISSION.md) owns the Postgres-backed worked-model catalogue, stable bundle URLs, coherent conversation/workpiece/evidence/net bundles and independently owned resume/fresh-copy path. The existing demo-mode fixture selector, crew-reservation tracer and Mission 7b's disposable SQLite conversation do not discharge it. Petrinaut simulation scenarios/metrics and a second worked-model bundle are excluded by default pending PM confirmation.
...
Do not create Mission 4 or Mission 8 drafts. Convert Mission 8 from the [successor cut](#mission-8-successor-cut-when-ready) when Tim's SRE-1013 resources exist. Mission 5 on FE-1574 was Mission 6's transport prerequisite; Missions 6, 7a and 7b are archived, and Mission 7c is live in root authority. Mission 11 stays deliberately shallow until Chris and Yannis accept input artifacts, one optimisation question, scenario/parameter representation, execution boundary, expected result, and minimum credibility checks.
