...
> Canonical future-planning spine, shared frame and backlog index only; not execution authority. [`MISSION.md`](MISSION.md) is the sole live authority for Mission 7b's ordinary batched construction/correction close-out under FE-1573. [Mission 7a](docs/mission-archive/7a-workpiece-construction-explanation-groundwork.md) is archived on this child branch while its engineering PR completes external review. [Draft Mission 7c](docs/mission-drafts/7c-inventory-worked-model.md) is the substantial Inventory worked-model successor under Lu's explicit extension of the FE-1573 multi-PR exception. The former Step B programme remains [after-demo evaluation](docs/mission-drafts/7-explainable-construction.md). Older sequencing and deployment assertions below are historical planning inputs, not current execution or environment facts.
...
M7b  FE-1573 successor — ordinary batched structural construction, correction, reopen, and experimental create-new entry
M7c  FE-1573 explicit third-PR exception — Inventory worked-model bundle; compiler/layout/why/tool-topology/Postgres-copy closure
