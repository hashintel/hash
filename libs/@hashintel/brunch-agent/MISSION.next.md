...
**Current scope:** [Mission 7b](MISSION.md) owns a plural database-backed scenario catalogue; Inventory purchasing as a common flagship baseline with a second substantial scenario selected after observed strain; broad honest why coverage across every consequential visible flagship element; ordinary PM exploration/correction/reopen and start-from-scratch; and a recording of persona-driven visible construction. Its first throughline is the bounded ordered-stop `mutate_petrinet` probe; production batching depends on that evidence. Constraints plus executed experiments follow the fundamental path and await Chris's API/procedure. Full arbitrary parity, general multi-user revision, universal dynamics, semantic model-diff UI, route aliases, OpenAI migration, optimisation and Chris/Yannis handoff remain deferred or require explicit re-entry under the live contract.
...
M7a  FE-1573 engineering PR — workpiece/construction/why groundwork; UI closeout required before merge
...
The live [Mission 7b](MISSION.md) owns the seeded worked-scenario catalogue, Inventory-comparable flagship, broad consequential-element why coverage, PM exploration/correction/start-from-scratch, complete persona-to-construction recording, accepted ordered mutation probe and scope-strain ledger. It brings the coherent template-to-working-copy path and only the selected scenarios' required correction/change/tool/dynamics/simulation slice forward from later general portfolios. The [evaluation draft](docs/mission-drafts/7-explainable-construction.md) retains cross-scenario semantic/behavioural reliability, expanded passage/adversarial/lifecycle matrices and population claims after the demo; it cannot be cited to excuse a thin flagship.
...
| Before September live demo | Seed a plural scenario catalogue; open an owned working copy of a substantial flagship with retained conversation/revisions/workpiece/connected net; inspect multiple why/source classes; correct and update workpiece/net without unrelated rebuilding; inspect updated why; reopen/rehearse; simulate if the agreed claim is executable — live `MISSION.md` |
| Required September recording | Entire realistic persona interview, recurring workpiece revisions and native substantial-net construction through the visible product, with retained real records and no hidden operator construction — live `MISSION.md` |
| Demo delivery | Stable `?scenario=...` URLs, coherent template identities, Postgres startup catalogue updates, independently continuable copies, intended host/revision/access and safe rehearsal reset — live `MISSION.md` and delivery section below |
...
### Stable template delivery consumed by Mission 7b

Live [Mission 7b](MISSION.md) now owns the Postgres-backed two-scenario catalogue, stable scenario URLs, coherent conversation/workpiece/evidence/net bundles and independently owned resume/fresh-copy path. The existing demo-mode fixture selector and crew-reservation tracer do not discharge it.
...
Do not create Mission 4 or Mission 8 drafts. Convert Mission 8 from the [successor cut](#mission-8-successor-cut-when-ready) when Tim's SRE-1013 resources exist. Mission 5 on FE-1574 was Mission 6's transport prerequisite; Mission 6 and Mission 7a are archived, and Mission 7b is live in root authority. Mission 11 stays deliberately shallow until Chris and Yannis accept input artifacts, one optimisation question, scenario/parameter representation, execution boundary, expected result, and minimum credibility checks.
