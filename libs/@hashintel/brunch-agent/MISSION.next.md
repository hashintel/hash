...
**Current scope amendment:** the live [Mission 7](MISSION.md#product-results-and-execution-graph) now owns persona-produced, browser-visible sessions, their bounded curated-fixture portability and local image seed/demo access. This advances that consumer-specific work from the fixture/seed promotion possibilities below; general import, remote deployment and the remaining Mission 8 infrastructure stay deferred. The live mission is the sole detailed contract for the advanced work.
