...
**Current scope:** [Mission 7a](MISSION.md) closes the mechanical workpiece/construction/why integration for PR review; its UI remediation must precede merge and preserve [FE-1645/#9634](https://github.com/hashintel/hash/pull/9634). The live September target is open → explain → correct → update; the desired additional output is a video of complete persona elicitation and actual net construction. [Mission 7b](docs/mission-drafts/7b-september-demo.md) owns that detail, the topology direction and the unresolved construction-tool choice. Semantic effectiveness is evaluated separately, not enforced as a runtime or pre-PR completeness gate. Stable template delivery remains selected direction if the demo needs independent working copies; inspect the actual demo host and copy needs before building its full catalogue.
...
M7b  FE-1573 successor — live review/correction flow; desired complete elicitation/construction video
...
The [7b draft](docs/mission-drafts/7b-september-demo.md) owns the live correction flow, desired complete elicitation/construction recording, ownership/topology changes and unresolved tool design. It brings only the required correction/change slice forward from Missions 9/10. The [evaluation draft](docs/mission-drafts/7-explainable-construction.md) retains broad semantic, behavioural, explanation-coverage, adversarial and lifecycle evaluation after the demo. The former A1–A6/B1–B3 campaign and predecessor gates are not a current execution schedule.
...
| Before September live demo | Open retained example, inspect why/sources, correct, update workpiece/net, inspect the new explanation, reopen/rehearse — 7b draft |
| Desired September recording | Entire persona-driven interview and native net construction, readable UI, retained real records; tool approach decided first — 7b draft |
| Conditional demo dependency | Intended host/revision/access and independent-copy requirements; use the stable-template contract only where required — 7b draft and delivery section below |
| After demo | Full model-quality/behaviour/useful-coverage evaluation; broader repeat/change/retirement, reviewer classes and cases; general dynamics/stochastics, preview, source/plugin and optimisation work — evaluation draft, drafts 9–11 and named backlog sections |

If simulation/optimisation or a broader user/copy posture becomes part of the demo, amend the scope explicitly rather than implying it from the old six-beat frame. A meaningful recorded construction flow is required for the video target, but the old complex-case semantic benchmark is not its acceptance instrument.
...
- [Mission 7b — September demo flow](docs/mission-drafts/7b-september-demo.md), following Part A UI closeout
