...
Mechanical install/build/probe commands require verified OS process-tree network denial with the retained [native-delivery profiles](docs/evidence/implementations/fe-1573-step-a/native-local-delivery/installation.md); offline package flags alone are insufficient. Only scoped local browser/listener work uses loopback. Missing artifacts stop work; previously disclosed downloads remain incidents. Never silently rerun with network enabled.
