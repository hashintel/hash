...
start. **Repeat question** is authorized but not yet implemented: only the
approved durable Brunch marker may enable it, and the final text segment remains
invalid question authority. Proof item 5 is complete
