...
- `oracles/mission-4-activation-and-restraint-ruler-v1.md` — proposed oracle for Mission 4 proof items 4 and 5 (capability activation, routing, dosage, restraint) observed through the persona harness; pending owner acceptance.
