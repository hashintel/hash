...
- `oracles/mission-4-activation-and-restraint-ruler-v1.md` — owner-accepted proof-of-life oracle for Mission 4 capability activation, controlled routing restraint, required reads, opening dosage, and template timing; accepted on 2026-09-03 but not campaign-frozen.
