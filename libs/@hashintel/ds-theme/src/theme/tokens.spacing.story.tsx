...
const ScaleColumn = ({ scale }: { scale: string }) => (
  <VStack gap="1" alignItems="flex-start">
    <span className={css({ fontSize: "sm", fontWeight: "semibold", mb: "2", textTransform: "capitalize" })}>
      {scale}
    </span>
    {steps.map((step) => (
...
export const Spacing: Story = () => (
  <VStack gap="6" alignItems="flex-start" p="6">
    ...
    <p className={css({ fontSize: "sm", color: "neutral.600", maxWidth: "600px" })}>
      Spacing scales for different density modes. Default is the base scale, compact reduces spacing for dense UIs, 
      and comfortable increases spacing for more relaxed layouts.
    </p>
