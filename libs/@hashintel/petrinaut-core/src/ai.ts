...
export const petrinautDocSummaries: Record<PetrinautDocName, string> = {
  ...
  "ad-hoc-scenarios":
    "Inline initial state + parameters without saving a scenario: the shared form (variables, fixed vs template rows, shared columns, expressions), its three surfaces (quick simulation, experiments, optimizations), and Optimize selections with generated adhoc.* parameter names.",
  experiments:
