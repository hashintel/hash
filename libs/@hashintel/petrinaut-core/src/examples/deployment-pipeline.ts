            ...
            netParameters: [
              {
                ...
                expression: "scenario.deployment_rate",
                optimize: null,
              },
              {
                parameterId: "param__incident_rate",
                expression: "scenario.incident_rate",
                optimize: null,
              },
              {
                parameterId: "param__deployment_risk_multiplier",
                expression: "scenario.risk_multiplier",
                optimize: null,
              },
              {
                parameterId: "param__mean_deployment_size",
                expression: "scenario.mean_size",
                optimize: null,
              },
              {
                parameterId: "param__incident_resolution_rate",
                expression: "scenario.resolution_rate",
                optimize: null,
              },
            ],
            places: {},
        ...
        initialState: {
          ...
          content: {
            ...
            netParameters: [
              ...
              {
                parameterId: "param__incident_severity_multiplier",
                expression: "scenario.severity_multiplier",
                optimize: null,
              },
              {
                parameterId: "param__incident_resolution_rate",
        ...
        initialState: {
          ...
          content: {
            ...
            netParameters: [
              ...
              {
                parameterId: "param__deployment_finish_base_rate",
                expression: "scenario.finish_rate",
                optimize: null,
              },
              {
                parameterId: "param__deployment_risk_multiplier",
        ...
        initialState: {
          ...
          content: {
            ...
            netParameters: [
              ...
              {
                parameterId: "param__deployment_failure_base_rate",
                expression: "scenario.failure_base_rate",
                optimize: null,
              },
              {
                parameterId: "param__incident_severity_multiplier",
