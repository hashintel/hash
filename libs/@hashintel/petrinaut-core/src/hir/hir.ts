 ...
 *
 * The HIR is a typed, source-spanned, JSON-serializable expression tree that
 * sits between the surface language (today TypeScript, later the Petrinaut
 * DSL) and the execution backends (JavaScript today, WASM/GPU later).
 *
 * Design invariants:
