...
role: Generates the WGSL compute shader for a net, one module per concern (token layout, transition firing, output emission, dynamics, histograms, metric sampling, run parameters)
---
