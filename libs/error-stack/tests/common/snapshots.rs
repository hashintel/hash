...
fn snap_suffix(hooks_suffix: bool) -> String {
    #[allow(unused_mut)]
...
pub fn prepare(suffix: bool, hooks_suffix: bool, enable_backtrace: bool) -> impl Drop {
    setup(enable_backtrace);

    let mut settings = insta::Settings::clone_current();
    if suffix {
        settings.set_snapshot_suffix(snap_suffix(hooks_suffix));
    }
