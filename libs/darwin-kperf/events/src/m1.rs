...
impl M1Event {
    /// Converts a generic [`Event`] to its M1-specific variant, returning `None` if
    /// the event is unavailable on M1.
    #[must_use]
    #[inline]
    pub const fn from_event(event: Event) -> Option<Self> {
        match event {
            ...
            Event::ArmL1ICache => None,
            Event::ArmMemAccess => None,
            Event::ArmMemAccessChecked => None,
            Event::ArmMemAccessCheckedRd => None,
            Event::ArmMemAccessCheckedWr => None,
            Event::ArmMemAccessRd => None,
            Event::ArmMemAccessWr => None,
            Event::ArmStall => None,
            ...
            Event::BranchBrIndirMispredNonspec => None,
            ...
            Event::CoreWaitingSmeEngineCycle => None,
            Event::DecodeUop => None,
            ...
            Event::InstBranchCallIndir => None,
            ...
            Event::InstMicrocoded => None,
            Event::InstSimdAlu => Some(Self::InstSimdAlu),
            Event::InstSimdAluVec => None,
            ...
            Event::LdSrcCoreSameclusterNonspec => None,
            Event::LdSrcLlCacheNonspec => None,
            Event::LdSrcMemsysNonspec => None,
            Event::LdSrcMemsysOtherdieNonspec => None,
            Event::LdSrcOtherclusterNonspec => None,
            Event::LdSrcOtherclusterOtherdieNonspec => None,
            Event::LdSrcPl2CacheNonspec => None,
            Event::LdSrcStoreNonspec => None,
            Event::LdUnitUop => Some(Self::LdUnitUop),
            Event::LdUnitWaitingYoungL1DCacheMiss => None,
            Event::LdstMemAccessCheckedX2K => None,
            Event::LdstOldestMteTagCheckCycle => None,
            ...
            Event::MapDispatchBubbleTakenbrSlot => None,
            ...
            Event::Pl2CacheAccess => None,
            Event::Pl2CacheAccessInstruction => None,
            Event::Pl2CacheAccessMmu => None,
            Event::Pl2CacheAccessSt => None,
            Event::Pl2CacheMiss => None,
            Event::Pl2CacheMissInstruction => None,
            Event::Pl2CacheMissLd => None,
            Event::Pl2CacheMissMmu => None,
            Event::Pl2CacheMissSt => None,
...
impl EventInfo for M1Event {
    ...
    fn c_name(&self) -> &'static core::ffi::CStr {
        match self {
            ...
            Self::ScheduleUop => c"SCHEDULE_UOP",
    ...
    fn description(&self) -> &'static str {
        match self {
            ...
            Self::ScheduleUop => "Uops issued by the scheduler to any execution unit",
