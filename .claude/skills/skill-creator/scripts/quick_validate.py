...
# ///
"""
Quick validation script for skills - validates against Agent Skills specification
...
def validate_skill(skill_path):
    """Basic validation of a skill against Agent Skills specification"""
    ...
    if allowed_tools is not None:
        if not isinstance(allowed_tools, str):
            return False, f"allowed-tools must be a string (space-delimited list), got {type(allowed_tools).__name__}"
