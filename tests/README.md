...
_The tests require the compose stack to be running. See [the root README](/README.md#external-services-test-mode) for information on doing this without polluting the development database._
