...
**Flows** are fixed sequences of steps — i.e. processes — which can be mapped out within HASH, and executed by [agents](/guide/agents) on your behalf.

Flows allow for the reliable, predictable execution of specific actions, in contrast to [goals](/guide/agents/goals), which agents may attempt to satisfy according to their own best judgement.
...
- **Automatic:** flows can also be run without user input, on autopilot, by satisfying the condition(s) of a [trigger](/guide/flows/triggers) present within a flow;
...
In the future, we'll support optionally making flows public, as well as sharing them with specific users outside of the webs that flows belong to.
