...
[Flows](/guide/flows) allow automated sequences of steps to be actioned using HASH, and [AI agents](/guide/agents/goals) are capable of planning and executing new flows, with or without humans in the loop.
...
HASH can also be directly queried [in natural language](/guide/agents/chat), and connected to a [growing range](/guide/integrations) of external tools.
