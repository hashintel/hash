...
Properties store individual pieces of information about [entities](/glossary/entities) as [values](/glossary/values). All properties on an entity are inferred from that [entity's type(s)](/glossary/entity-types).
...
Properties are one of two kinds of [attributes](/glossary/attributes) (things which describe entities), with the other being [links](/glossary/links).
...
- contains information about what the property’s value is expected to look like, either through reference to [data types](/glossary/data-types) or other property types.
