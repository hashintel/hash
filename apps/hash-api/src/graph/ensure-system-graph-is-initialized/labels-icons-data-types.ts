...
const _propertyTypeOneOfChanges: {
  ...
  "https://hash.ai/@h/types/property-type/website-url/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/uri/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/pinned-entity-type-base-url/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/uri/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/profile-url/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/uri/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/email/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/email/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/expired-at/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/datetime/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/resolved-at/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/datetime/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/deleted-at/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/datetime/v/1" },
  ],
  "https://hash.ai/@h/types/property-type/read-at/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/datetime/v/1" },
  ],
  ...
  "https://hash.ai/@linear/types/property-type/period-upload-volume/v/1": [
    { $ref: "https://hash.ai/@h/types/data-type/megabytes/v/1" },
  ],
...
> = {
  "https://hash.ai/@h/types/entity-type/file/v/2": {
  ...
  "https://hash.ai/@h/types/entity-type/image/v/2": {
    icon: "/icons/types/file-image.svg",
    titlePlural: "Image Files",
  },
  "https://hash.ai/@h/types/entity-type/block/v/1": {
    icon: "/icons/types/cube.svg",
    titlePlural: "Blocks",
  },
  "https://hash.ai/@h/types/entity-type/block-collection/v/1": {
    icon: "/icons/types/cubes.svg",
    titlePlural: "Block Collections",
  },
  "https://hash.ai/@h/types/entity-type/profile-bio/v/1": {
  ...
  "https://hash.ai/@h/types/entity-type/service-account/v/1": {
    icon: "/icons/types/person-to-portal.svg",
    titlePlural: "Service Accounts",
  },
  "https://hash.ai/@h/types/entity-type/linkedin-account/v/1": {
    icon: "/icons/types/linkedin.svg",
    titlePlural: "LinkedIn Accounts",
  },
  "https://hash.ai/@h/types/entity-type/twitter-account/v/1": {
    icon: "/icons/types/x-twitter.svg",
    titlePlural: "Twitter Accounts",
  },
  "https://hash.ai/@h/types/entity-type/tiktok-account/v/1": {
    icon: "/icons/types/tiktok.svg",
    titlePlural: "TikTok Accounts",
  },
  "https://hash.ai/@h/types/entity-type/facebook-account/v/1": {
    icon: "/icons/types/facebook.svg",
    titlePlural: "Facebook Accounts",
  },
  "https://hash.ai/@h/types/entity-type/instagram-account/v/1": {
    icon: "/icons/types/instagram.svg",
    titlePlural: "Instagram Accounts",
  },
  "https://hash.ai/@h/types/entity-type/github-account/v/1": {
  ...
  "https://hash.ai/@h/types/entity-type/page/v/1": {
  ...
  "https://hash.ai/@h/types/entity-type/canvas/v/1": {
    icon: "/icons/types/rectangle.svg",
    titlePlural: "Canvases",
  },
  "https://hash.ai/@h/types/entity-type/quick-note/v/1": {
    icon: "/icons/types/note-sticky.svg",
    titlePlural: "Notes",
  },
  "https://hash.ai/@h/types/entity-type/user-secret/v/1": {
    titlePlural: "User Secrets",
    icon: "/icons/types/user-lock.svg",
  },
  "https://hash.ai/@h/types/entity-type/comment/v/6": {
    icon: "/icons/types/comment.svg",
    titlePlural: "Comments",
  },
  "https://hash.ai/@h/types/entity-type/notification/v/1": {
  ...
  "https://hash.ai/@h/types/entity-type/service-feature/v/1": {
    icon: "/icons/types/plug-circle-check.svg",
    titlePlural: "Service Features",
    labelProperty: "https://hash.ai/@h/types/property-type/feature-name/",
  },
  "https://hash.ai/@h/types/entity-type/usage-record/v/2": {
...
> = {
  ...
  "https://hash.ai/@h/types/entity-type/incurred-in/v/1": {
    inverse: {
      title: "Incurred",
    },
  },
  ...
  "https://hash.ai/@h/types/entity-type/created/v/1": {
    inverse: {
      title: "Created By",
    },
  },
  "https://hash.ai/@h/types/entity-type/updated/v/1": {
    inverse: {
      title: "Updated By",
    },
  },
...
const _typeRenames: Record<SystemEntityTypeId, string> = {
  // @ts-expect-error system types have been regenerated, so the codebase thinks this has already been renamed
  "https://hash.ai/@h/types/entity-type/image/v/2": "Image File",
  "https://hash.ai/@h/types/entity-type/quick-note/v/1": "Note",
};
