...
const migrate: MigrationFunction = async ({
  ...
  const recordsBatchLink = await link(
    "Records Batch",
    "Recorded On",
    /** presupposes source, etc */
    "A batch recorded by something movement.",
  ...
  const yieldsBatchLink = await link(
    ...
    "Yielded By",
    /** presupposes source */
    "A batch produced by something order.",
  ...
  const departsFromLink = await link(
    "Departs From",
    "Departure For",
    "The site from which something departs.",
    "/icons/types/arrow-right-from-bracket.svg",
  );
  const arrivesAtLink = await link(
    "Arrives At",
    "Arrival For",
    "The site or customer at which a shipment arrives.",
    "/icons/types/arrow-right-to-bracket.svg",
  );
  const postedAgainstLink = await link(
    "Posted Against",
    "Has Posting",
    "The source document or requirement against which a movement is posted.",
    "/icons/types/clipboard-check.svg",
  );
  const referencesDocumentLink = await link(
    "References Document",
    "Referenced By",
    "A related source document referenced by this document or posting.",
        ...
        outgoingLinks: [
          ...
          },
          {
            ...
            destinationEntityTypes: [
              ...
              _materialReservationEntityType.schema.$id,
            ],
          },
          {
            linkEntityType: referencesDocumentLink,
            destinationEntityTypes: [
              purchaseOrderItemEntityType.schema.$id,
              productionOrderEntityType.schema.$id,
              deliveryItemEntityType.schema.$id,
