...
const seedFlowTestTypes = async () => {
  ...
  const valuePropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "Value",
  ...
  const unitPropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "Unit",
  ...
  const multiplierPropertyType = await createSystemPropertyTypeIfNotExists(
    ...
    authentication,
    {
      propertyTypeDefinition: {
        title: "Multiplier",
        description: 'The multiplier of something (e.g. "millions", "thousands", etc.)',
        possibleValues: [{ primitiveDataType: "text" }],
      },
      webId,
    },
  ...
  const marketCapitalizationPropertyType = await createSystemPropertyTypeIfNotExists(
    context,
    authentication,
    {
      propertyTypeDefinition: {
  ...
  const numberOfVotingRightsPropertyType = await createSystemPropertyTypeIfNotExists(
    context,
    authentication,
    {
      propertyTypeDefinition: {
  ...
  const ownershipPercentagePropertyType = await createSystemPropertyTypeIfNotExists(
    context,
    authentication,
    {
      propertyTypeDefinition: {
  ...
  const stockMarketConstituentEntityType = await createSystemEntityTypeIfNotExists(
    context,
    authentication,
    {
      entityTypeDefinition: {
   ...
   */
  const companyEntityType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      title: "Company",
  ...
  const workedAtLinkType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      allOf: [blockProtocolEntityTypes.link.entityTypeId],
      title: "Worked At",
  ...
  const googleScholarUrlPropertyType = await createSystemPropertyTypeIfNotExists(
    context,
    authentication,
    {
      propertyTypeDefinition: {
  ...
  const githubUrlPropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "GitHub URL",
   ...
   */
  const personEntityType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      title: "Person",
  ...
  const hasAuthorLinkEntityType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      allOf: [blockProtocolEntityTypes.link.entityTypeId],
      title: "Has Author",
  ...
  const _researchPaperType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
  ...
  const _article = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      title: "Article",
  ...
  const largeLanguageModelProviderEntityType = await createSystemEntityTypeIfNotExists(
    context,
    authentication,
    {
      entityTypeDefinition: {
  ...
  const trainingDataCutoffDatePropertyType = await createSystemPropertyTypeIfNotExists(
    context,
    authentication,
    {
      propertyTypeDefinition: {
        title: "Training Data Cutoff Date",
        description: "The date until which the training data was included for the model.",
  ...
  const baseClockPropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "Base Clock",
  ...
  const widthPropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "Width",
      description: "Width in mm.",
      possibleValues: [{ dataTypeId: systemDataTypes.millimeters.dataTypeId }],
    },
    webId: hashWebId,
  });

  const lengthPropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "Length",
  ...
  const powerDrawPropertyType = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
      title: "Power Draw",
  ...
  const trainingStartDate = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
  ...
  const trainingEndDate = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
  ...
  const tokenOutputSpeed = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
  ...
  const contextWindow = await createSystemPropertyTypeIfNotExists(context, authentication, {
    propertyTypeDefinition: {
  ...
  const _aiModelEntityType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      title: "AI Model",
      description:
  ...
  const _graphicsCardEntityType = await createSystemEntityTypeIfNotExists(context, authentication, {
    entityTypeDefinition: {
      title: "Graphics Card",
