...
const instrumentFiles = [
  ...
  "apps/brunch-agent/src/agents/chat-agent/skills/sdcpn-modelling/pn-construction.md",
  "apps/brunch-agent/src/agents/chat-agent/skills/sdcpn-modelling/checks.md",
