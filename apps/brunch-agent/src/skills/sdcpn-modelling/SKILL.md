...
description: Conduct a process-modelling interview, keep a structured Markdown IR, and construct Petri-net JSON the expert can load. Use when someone wants a simulatable process model, a Petri net, or an interview that produces one.
---
