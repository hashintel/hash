...
const instrumentFiles = [
  ...
  "apps/brunch-agent/src/agents/chat-agent.ts",
  "apps/brunch-agent/src/runbook-artifacts.ts",
  "apps/brunch-agent/src/runbook-elicitation-run.ts",
  "apps/brunch-agent/src/skills/sdcpn-modelling/SKILL.md",
  "apps/brunch-agent/src/skills/sdcpn-modelling/elicitation.md",
  "apps/brunch-agent/src/skills/sdcpn-modelling/ir-template.md",
  "apps/brunch-agent/src/skills/sdcpn-modelling/pn-construction.md",
  "apps/brunch-agent/src/skills/sdcpn-modelling/checks.md",
