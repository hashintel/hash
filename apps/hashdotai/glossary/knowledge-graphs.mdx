...
A knowledge graph is a collection of linked concepts. It uses a [graph structure](/glossary/graphs) to store semantically linked entities (e.g. objects, concepts, events).
