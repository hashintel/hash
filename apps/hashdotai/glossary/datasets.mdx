...
Typically, each row corresponds to one [entity](/glossary/entities), and each column to a [property](/glossary/properties). The intersection of each column and row contains the relevant property’s [value](/glossary/values).
