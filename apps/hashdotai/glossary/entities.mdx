...
If you’re using our advanced [HASH for simulation](https://hash.ai/index) platform, you might be wondering about the relationship between entities and [agents](https://hash.ai/glossary/agent-based-modeling). For all practical purposes, you can think of both as the same thing. In future releases of [HASH Core](https://hash.ai/platform/core) and [HASH Engine](https://hash.ai/platform/engine) we’ll support instantiating entities from a HASH workspace directly within simulations (as agents), as well as assigning expected [behaviors](https://hash.dev/docs/simulation/creating-simulations/behaviors) to entity types in [HASH](https://hash.ai/platform/hash).
