...
There are lots of ways to license code, including HASH [simulation models](/glossary/simulation).

Whilst simulation models can be published transparently and publicly on [HASH](/platform/index) with all rights regarding their usage reserved under traditional copyright law, this is fairly uncommon. More often, one of two alternatives takes place:
