...
<Callout style="information" type="coming-soon">
  This glossary definition refers to technical concepts that are only
  relevant to developer users of HASH who are familiar with programming.
  Understanding these is not necessary to use the HASH application
  itself.
</Callout>
