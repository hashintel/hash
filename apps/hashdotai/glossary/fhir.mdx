...
The <a href="http://hl7.org/fhir/" target="_blank">Fast Healthcare Interoperability Resources standard</a> (FHIR) is a specification for electronic healthcare data created in 2012. Making healthcare data standardized and discoverable has been a longstanding goal of the industry, to facilitate accurate records being shared between different providers and improve shared understanding (helping ensure different healthcare providers "speak the same language"). The FHIR was created by created by the <a href="https://en.wikipedia.org/wiki/Health_Level_Seven_International" target="_blank">Health Level Seven International</a> (HL7) organization to promote semantic markup of records that work with JSON, XML, or RDF. The FHIR's conceptual primitive is the '<a href="https://www.hl7.org/fhir/resource.html" target="_blank">resource</a>':
