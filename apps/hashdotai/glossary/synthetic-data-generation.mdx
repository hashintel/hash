...
By creating a simulation that models the real world, the results of the simulation can be used in place of, or in addition to, directly observed data. In this way a small investment of 'data' can be supercharged with a simulation to create a much larger dataset, and a more performant [machine learning](/glossary/machine-learning) (ML) system.
