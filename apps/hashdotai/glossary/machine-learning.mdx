...
For supervised learning approaches, [datasets](https://hash.dev/docs/simulations/creating-simulations/datasets) can be added to the simulation as standard tables (CSV files) or standardized web formats (JSON files).
