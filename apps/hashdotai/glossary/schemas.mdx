...
Schemas are _descriptions of things,_ and in HASH they are used to define [types](/glossary/types). These types provide standardized descriptions of things in the real-world that can then be collaboratively maintained and improved.
...
If a sub-type or top-level schema you require doesn’t exist, you can create one with HASH from scratch, or by [forking](/glossary/fork) an existing one.
