...
In HASH stochastic simulations can be created by using the [HASH standard library statistical distributions.](https://hash.dev/docs/simulation/concepts/designing-with-distributions) Conversely, you can create [deterministic simulations](https://hash.dev/docs/simulation/extra/determinism) by ensuring the stochastic elements of a simulation use the same starting seed, thus returning the same results every run.
