...
1. **[user](#users) accounts**, each representing an individual human, with its own web (e.g. [hash.ai/@d](/@d))
1. **[org](#orgs) accounts**, each of which corresponds to a shared web (e.g. [hash.ai/@soho](/@soho)) managed by one or more users
