---
title: Documents
description: Linear pages
meta-title: Documents - HASH
meta-description: Documents are pages composed of blocks arranged in a fixed, linear order. In English this is top-to-bottom and left-to-right, but in other languages this may vary.
...
## How Blocks work with Entities, Links, and Entity Types<a id="#how-blocks-work-with-entities-links-and-entity-types" />
...
## The default Block: Paragraph Block<a id="#the-default-block-paragraph-block" />
...
## Reordering Blocks<a id="#reordering-blocks" />
...
## Commenting on a Block<a id="#commenting-on-a-block" />
...
## Mentioning other users<a id="#mentioning-other-users" />
