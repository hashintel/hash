...
If you mention another user of HASH, depending on their account settings, and whether or not they can view the page you are mentioning them from, they may receive a notification that you have mentioned them, with a link to the block/page containing the mention.
