...
You can provide an AI [worker](/guide/workers) with a goal in natural language, and it will "translate" this into a [flow](/guide/flows).

Alternatively, you can manually create your own flows in HASH.

# Creating a flow with AI

Click the "Workers" tab in the left-hand sidebar of HASH, and make sure you're on the "Goals" page. Enter your goal into the form provided, and follow the on-screen instructions.
