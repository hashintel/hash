...
meta-title: User Guide - HASH
meta-description: An introduction to HASH and an overview of its core features and capabilities
sidebar-title: What is HASH
---
...
- create [documents](https://hash.ai/guide/pages/documents) that cleanly and reliably incorporate live or historical data
- build your own dashboards and custom views of data (atop [canvases](https://hash.ai/guide/pages/canvases))
- create interfaces and [apps](https://hash.ai/guide/apps) on top of data... with _or without_ writing code
