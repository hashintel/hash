...
We use the term 'account' to refer to both **users** and **orgs** in HASH. All users and orgs have a _web_ and an _account name_, such as `@example`. This can be used to access an account's public profile, such as [hash.ai/@example](https://hash.ai/@example).
