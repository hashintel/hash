...
**Property types** provide semantic descriptiosn of [properties](/guide/entities/attributes#properties), and specify the expected [data types](/guide/types/data-types) of their values.
