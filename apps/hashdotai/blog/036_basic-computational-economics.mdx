...
Changing the state can change the 3D appearance of an agent, using [reserved fields](https://hash.dev/docs/simulations/create/anatomy-of-an-agent/state).
...
[Learn more about creating experiments in HASH >](https://hash.dev/docs/simulations/create/experiments)
