...
This poses interesting opportunities for simulation. As more and more business actions are represented in an RPA format for automation, those same workflows can be simulated by [generating process models](https://hash.dev/docs/simulations/concepts/designing-with-process-models) from their RPA representations. Over time, in an organic manner, you can generate a digital twin of your business, which in a virtuous cycle can help you improve your RPA processes. In essence anything that can be orchestrated using software can be simulated using software!
