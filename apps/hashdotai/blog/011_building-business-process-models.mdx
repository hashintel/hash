...
We've released a new plugin for HASH, built atop the [hCore API](https://hash.ai/docs/simulation/api/hcore), and utilizing the [HASH business process library](https://simulation.hash.ai/@hash/process), which provides a graphical user interface enabling easy simulation of business processes and operations.
