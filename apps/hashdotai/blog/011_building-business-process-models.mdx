...
- There are lots of tools for building process models, but relatively few for quickly simulating and analyzing them
...
...along with our video tutorial on [building a ticket queue process model](https://hash.dev/docs/simulations/tutorials/building-process-models). Happy simulating!
