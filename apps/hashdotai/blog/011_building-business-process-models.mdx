...
We've released a new plugin for HASH, built atop the [hCore API](https://hash.dev/docs/simulation/api/hcore), and utilizing the [HASH business process library](https://simulation.hash.ai/@hash/process), which provides a graphical user interface enabling easy simulation of business processes and operations.
...
- [Key concepts in process modeling](https://hash.dev/docs/simulation/concepts/designing-with-process-models/process-model-concepts)
- [Getting started with the HASH process modeling plugin](https://hash.dev/docs/simulation/concepts/designing-with-process-models/using-the-process-model-builder)
- [Adding data to process models](https://hash.dev/docs/simulation/concepts/designing-with-process-models/using-data-in-a-process-model)
- [Analyzing process models](https://hash.dev/docs/simulation/concepts/designing-with-process-models/analyzing-process-models)
- [Running experiments with process models](https://hash.dev/docs/simulation/concepts/designing-with-process-models/experimenting-with-process-models)

Along with our video tutorial on [building a ticket queue process model](https://hash.dev/docs/simulation/tutorials/building-process-models).
