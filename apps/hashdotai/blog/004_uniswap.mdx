...
[This simulation models the Uniswap protocol and evaluates arbitrage between two balancer pools](https://simulation.hash.ai/@b/uniswap/main) and the gains / potential [impermanent loss](https://uniswap.org/docs/v2/advanced-topics/understanding-returns/)
