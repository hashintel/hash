...
[_Learn how to build a process model simulation using a visual interface._](https://hash.dev/docs/simulation/concepts/designing-with-process-models/using-the-process-model-builder)
...
_Read about [Adding Data to a Process Model](https://hash.dev/docs/simulation/concepts/designing-with-process-models/using-data-in-a-process-model)._
