...
[_Learn how to build a process model simulation using a visual interface._](https://hash.dev/docs/simulations/create/advanced/designing-with-process-models/using-the-process-model-builder)
...
See [Analyzing Process Models](https://hash.dev/docs/simulations/create/advanced/designing-with-process-models/analyzing-process-models) for more on graphing process models, and Collaboration to learn how to share a process model simulation with your team.
...
_Read about [Adding Data to a Process Model](https://hash.dev/docs/simulations/create/advanced/designing-with-process-models/using-data-in-a-process-model)._
