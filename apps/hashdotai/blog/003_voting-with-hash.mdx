...
These actions are performed by the **get\_closest\_poll.js** behavior.
...
The **send\_voters.js** behavior decides how many voters go to the polls on a given time step, and weighs the cost of travel distance into those calculations.
...
- `election_day_pct_closed` - This variable determines what percent of election day polling locations are randomly shut down. It behaves identically to "early\_pct\_closed".
