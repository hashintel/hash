...
1. **Population Immunity:** The percentage of the population (set in globals) level immunity, expressed as number of one dose patients _ 0.5, + number of second dose _ .95, divided by total population.
