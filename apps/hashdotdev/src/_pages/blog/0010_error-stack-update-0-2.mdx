...
postPhoto: blog/0010_error-stack-update-0-2/10_error-stack.webp
...
- The `error-stack` documentation has been greatly improved and we’re always open to more feedback ([create an Issue](https://github.com/hashintel/hash/tree/main/libs/error-stack) or [join us in Discord](https://discord.com/invite/BPMrGAhjPh)).
