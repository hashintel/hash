...
- The `error-stack` documentation has been greatly improved and we’re always open to more feedback ([create an Issue](https://github.com/hashintel/hash/tree/main/libs/error-stack) or [join us in Discord](https://hash.ai/discord)).
