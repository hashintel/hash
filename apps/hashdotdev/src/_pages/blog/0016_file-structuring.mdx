...
- **Rule 5:** imports within sub-trees do not use relative paths (given increased refactoring costs, and by default imports are absolute in Rust with the exception of `make` sub-module exports public)
...
- **Rule 8:** unit tests are _not_ co-located with covered files
