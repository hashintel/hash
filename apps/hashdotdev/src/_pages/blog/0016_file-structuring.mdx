...
dateFirstPublished: "2023-08-30"
dateLastUpdated: "2023-08-30"
categories:
  - Our Approach
---
...
2. create top-level aliases for some folders, e.g. `@/foo` for `my-workspace/src/foo`.
   [Next.js supports this style](https://nextjs.org/docs/pages/building-your-application/configuring/absolute-imports-and-module-aliases); other types of workspaces can be configured to support it too.
