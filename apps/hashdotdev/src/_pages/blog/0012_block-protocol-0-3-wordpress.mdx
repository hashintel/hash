...
It also introduces a new [_Service_ module](https://blockprotocol.org/docs/spec/service-module), which defines an interface for accessing external services (aka. APIs) consistently and reliably from within blocks, irrespective of the integrations that an embedding application natively supports.
