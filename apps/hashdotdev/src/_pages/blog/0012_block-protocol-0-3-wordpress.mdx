...
postPhoto: blog/0012_block-protocol-0-3-wordpress/12_0-3-wordpress.webp
...
This release primarily focuses on the way data is structured, resulting in major updates to the Core and Graph modules [introduced in v0.2](https://hash.dev/blog/block-protocol-v02), making them significantly more robust, and expanding the modelling capabilities of links between entities. Read on to learn more or [jump over to the docs](https://blockprotocol.org/docs) to get into the technical details.
