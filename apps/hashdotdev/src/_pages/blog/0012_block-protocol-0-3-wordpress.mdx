...
authors:
  ...
  - name: Joel Spolsky
    ...
    photo: blog/authors/joel-spolsky.webp
...
dateFirstPublished: "2023-02-28"
dateLastUpdated: "2023-02-28"
categories:
  - Block Protocol
---
...
Þ 0.3 is accompanied by a new [_Service_ module](https://blockprotocol.org/spec/service), which defines an interface for accessing external services (aka. APIs) consistently and reliably from within blocks, irrespective of the integrations that an embedding application natively supports.
...
If you have ideas or want to get involved, we’d love to [hear from you](https://github.com/blockprotocol/blockprotocol/discussions).
