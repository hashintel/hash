...
At HASH, we maintain two (public) monorepos, [`hash`](https://github.com/hashintel/hash) and [`blockprotocol`](https://github.com/blockprotocol/blockprotocol). In the context of these monorepos, this post's scope is limited to the _internals_ of Yarn workspaces, while the locations of the workspaces themselves are out of scope. In a future post, we'll discuss competing approaches to structuring projects within multi-language monorepos and our recommendations here.
