...
If an "open-source alternative" to a tool like Palantir sounds of interest to you (or your org!), please feel free to get in touch [via the website](https://hash.ai/contact) or by dropping an email to [hey@hash.ai](mailto:hey@hash.ai?subject=Follow-up from tech trees blog post)
