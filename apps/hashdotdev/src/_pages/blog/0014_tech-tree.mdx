...
- In Progress (we're actively working on this, and might even have a working POC shipped in the HASH app)
- Done (we've delivered a proper working v1 of the feature within the platform, available to all users, or otherwise consider a node's work complete)
