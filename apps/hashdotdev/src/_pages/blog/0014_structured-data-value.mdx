...
- We are also planning support for user-defined custom data types (e.g. numbers within a certain range, or strings matching a certain pattern) which are not already found in the Block Protocol's [graph module specification](https://blockprotocol.org/docs/spec/graph). Read the [draft RFC](https://github.com/blockprotocol/blockprotocol/pull/355) to learn more.
