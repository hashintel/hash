...
We provide a system that does this for you in the `base.css` file provided by the [block starter template](https://github.com/blockprotocol/blockprotocol/tree/612431a4168b419f6843e254c6afa3c80fc55ede/libs/block-template).
