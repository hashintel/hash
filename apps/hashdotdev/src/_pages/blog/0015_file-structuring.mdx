...
postPhoto: blog/0015_file-structuring/0015_file-structuring.webp
...
<figure>
  <center>
    <img
      src="/blog/0015_file-structuring/tree-evolution-1.png"
      width={1176 / 6}
      height={884 / 6}
      alt="tree evolution (1)"
    />
    <img
      src="/blog/0015_file-structuring/tree-evolution-2.png"
      width={1194 / 6}
      height={886 / 6}
      alt="tree evolution (2)"
    />
    <img
      src="/blog/0015_file-structuring/tree-evolution-3.png"
      width={1198 / 6}
      height={886 / 6}
...
<img
  src="/blog/0015_file-structuring/resources-of-subtrees.png"
  width={1198 / 2}
  height={886 / 2}
...
<img
  src="/blog/0015_file-structuring/shared-resources-1.png"
  width={1198 / 3}
  height={886 / 3}
  alt="Shared resources (1)"
/>
<img
  src="/blog/0015_file-structuring/shared-resources-2.png"
  width={1198 / 3}
  height={886 / 3}
...
A simple project like an npm package or an SPA starts with a single file, e.g. `main.js`. This file works as the only entry point into the whole fractal tree, which can be of any size.

If necessary, it is possible to have multiple entry points, such as Next.js pages, executable CLI scripts, tests files and so on. The locations of these additional entry points should be determined by their usage, but our fractal rules still apply.
