...
postPhoto: blog/0006_block-protocol-v02/0006_bp-commodification.webp
title: "De-commodifying the internet, block by block"
subtitle: "Announcing Block Protocol version 0.2"
dateFirstPublished: "2022-06-15"
dateLastUpdated: "2022-06-15"
categories:
  - Block Protocol
---
...
With the introduction of version 0.2, we’re sharing a list of new modules we’re considering, from _Commenting_ to _Versionin_. We also have a number of important, open questions around updates we’re considering for the Core specification and Graph module. You can find all the details in the [RFCs & Roadmap section](https://blockprotocol.org/roadmap) of the spec and [join the discussion on GitHub](https://github.com/blockprotocol/blockprotocol/discussions).
