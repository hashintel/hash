...
authors:
  ...
  - name: Nate Higgins
    ...
    photo: blog/authors/nate-higgins.webp
...
dateFirstPublished: "2022-10-24"
dateLastUpdated: "2022-10-24"
categories:
  - Block Protocol
---
...
This is absolutely possible – it’s a burden on the embedding application, but we already require that applications translate their records into [a specified graph representation of entities and links](https://blockprotocol.org/spec/graph#entity-definition). For text, we could choose a popular format – some flavour of Markdown would be a good candidate – and provide utilities to handle the conversion to and from other common formats.
...
You can [read the formal specification for the hook module here](https://blockprotocol.org/spec/hook), but in summary:
...
If you have ideas, we’d love to hear them ([start a discussion](https://github.com/blockprotocol/blockprotocol/discussions) on GitHub).
