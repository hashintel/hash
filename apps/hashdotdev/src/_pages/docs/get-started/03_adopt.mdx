...
HASH is built atop the idea of incremental, optional adoption.

It should be useful in standalone, and become more useful as you layer in additional services.
