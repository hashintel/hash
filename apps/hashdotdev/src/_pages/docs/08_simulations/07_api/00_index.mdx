---
title: API
description: Application Programming Interface for HASH simulations
---
...
See the hCore Messaging API in action in the [Create a Simulation Dashboard tutorial](/docs/simulations/tutorials/create-a-simulation-dashboard).
