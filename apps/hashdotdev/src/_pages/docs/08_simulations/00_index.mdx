...
- **Cloud execution platform:** simulation runs and experiments will be executable as part of [flows](https://hash.ai/guide/flows). _Previously available as [hCloud](https://hash.dev/docs/simulations/create/h.cloud)._
...
HASH leverages composable [agents](/docs/simulations/create/anatomy-of-an-agent/), [behaviors](/docs/simulations/create/behaviors/) and types to make it fast and easy to create realistic, well-calibrated simulations.
