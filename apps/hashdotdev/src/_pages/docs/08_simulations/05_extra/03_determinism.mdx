...
1. the manner in which the [HASH Engine](https://hash.ai/platform/engine) (hEngine) builds [context](/docs/simulations/create/anatomy-of-an-agent/context) for an agent.
...
or by using one of the [Statistic libraries](/docs/simulations/create/libraries#hash-standard-library) included in HASH, such as those outlined in [Designing with Distributions](/docs/simulations/concepts/designing-with-distributions).
