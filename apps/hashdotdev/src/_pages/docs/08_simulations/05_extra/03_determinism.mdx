...
or by using one of the [Statistic libraries](/docs/simulations/create/libraries#hash-standard-library) included in HASH, such as those outlined in [Designing with Distributions](/docs/simulations/create/advanced/designing-with-distributions).
