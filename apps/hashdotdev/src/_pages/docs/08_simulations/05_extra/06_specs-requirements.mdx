...
<Hint style="success">
  **Simulations can be run on** [**HASH
  Cloud**](/docs/simulations/create/h.cloud) **with results
...
We recommend ensuring your device has at least 8GB of ram and a decent graphics card to create, run and explore most normal-sized simulations. If you stumble into performance issues, try using the "Run in Cloud" button in hCore to offload the heavy-lifting and computation to [hCloud](/docs/simulations/create/h.cloud).
