...
slug: simulation/run/experiment/experiment-types
...
Read more about [Optimization Experiments](/docs/simulations/run/experiment/optimization-experiments) in the next section of the docs.
