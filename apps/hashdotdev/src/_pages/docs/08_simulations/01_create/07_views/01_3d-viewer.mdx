---
title: 3D
slug: simulation/create/views/3d-viewer
...
Agents can be represented a huge variety of ways in HASH's 3D viewer, out of the box. Read more about [agent shapes](/docs/simulations/create/anatomy-of-an-agent/visualization/shapes).
