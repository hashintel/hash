...
An individual agent has a [state](/docs/simulations/create/agents/state) and a [context](/docs/simulations/create/agents/context).

![An Agent](https://cdn-us1.hash.ai/site/docs/image%20%2814%29.png)

When we define the [initial conditions](/docs/simulations/create/agents/initial-state) of a simulation, we're defining the initial agents that will be present in the first timestep of the simulation, each of which will have its own state and context.
