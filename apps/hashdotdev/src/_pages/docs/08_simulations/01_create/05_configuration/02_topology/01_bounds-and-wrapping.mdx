...
slug: simulation/create/configuration/topology/bounds-and-wrapping
...
<Hint style="info">
  Play around with the wrapping preset and bounds in [this HASH
  Simulation](https://simulation.hash.ai/@hash/wrapping-preset-playground)
</Hint>
