---
title: Topology
slug: simulation/create/configuration/topology
objectId: dceb2b2a-ef0f-4950-9e26-c4ab04f34346
---

An important keyword recognized by the [HASH Engine](https://hash.ai/platform/engine) (hEngine) is `topology`.
...
<Hint style="success">
  It's best to let HASH do the heavy lifting for you, especially for
  computationally-intensive work that we've already optimized.
</Hint>
