...
slug: simulation/create/collaboration/sharing-releasing
...
See [Composable behaviors](/docs/simulations/create/behaviors/composable-behaviors) for information on sharing and importing behaviors.
