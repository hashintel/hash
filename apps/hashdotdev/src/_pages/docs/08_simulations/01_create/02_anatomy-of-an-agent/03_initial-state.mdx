...
slug: simulation/create/anatomy-of-an-agent/initial-state
...
Within an `init.js` or `init.py` file you have access to the [context](/docs/simulations/create/anatomy-of-an-agent/context) of the simulation, where you can access the data and global variables attached to the simulation. You can use them to seed values in your initialization.
...
<Hint style="info">
  The `context` object in the **init** file is slightly different from the
...
You can learn more about all the **init** functions in the standard library [in this section of the docs](/docs/simulations/create/libraries/hash/init).
