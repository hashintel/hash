---
title: Visualization
slug: simulation/create/anatomy-of-an-agent/visualization
...
- `"shape": string` - if provided overrides the default "box" visualization for the agent.
  - There are built-in geometric shapes and 3D models. See the [Shapes](/docs/simulations/create/anatomy-of-an-agent/visualization/shapes) page for more information
...
<Hint style="info">
  ...
  [experiment](/docs/simulations/create/experiments/)\), it can be
  more useful to create [analysis charts and
  graphs](/docs/simulations/create/views/analysis/).
</Hint>
