---
title: Networks
slug: simulation/create/anatomy-of-an-agent/visualization/networks
...
<Hint style="info">
  Network drawing can be toggled by accessing the menu in the top right of the
  3D Viewer.
</Hint>

You can take this a step further and use the [Networks Library](https://simulation.hash.ai/@hash/networks) to provide agents easy access to their network neighbors.
