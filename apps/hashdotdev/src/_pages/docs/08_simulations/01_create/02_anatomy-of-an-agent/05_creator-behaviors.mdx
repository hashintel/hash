...
<Hint style="info">
  ...
  Demo ](/@hash/initialization-demo)which demos creator agents.
</Hint>
...
If you'd like to explore another simple example that uses these published behaviors, take a look at the [Wildfires](/@hash/wildfires-regrowth) or [Rock, Paper, Scissors](https://simulation.hash.ai/@hash/rock-paper-scissors/stable) simulations.
