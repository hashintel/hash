---
title: Behaviors
slug: simulation/create/behaviors
...
<Hint style="warning">
  ...
  hCloud](/docs/simulations/create/h.cloud), you'll need to [define
  Behavior Keys](/docs/simulations/create/behaviors/behavior-keys/)
...
<Hint style="info">
  ...
  [Messages](/docs/simulations/create/agent-messages/built-in-message-handlers#creating-agents-via-messages).
</Hint>
