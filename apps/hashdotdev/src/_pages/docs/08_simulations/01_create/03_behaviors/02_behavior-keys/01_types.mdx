---
title: Types
slug: simulation/create/behaviors/behavior-keys/types
...
<Hint style="warning">
  Once you define a field's behavior key, your simulation will return an error
  if you attempt to assign a value of the incorrect type \(unless it is an `any`
  type\).
</Hint>
