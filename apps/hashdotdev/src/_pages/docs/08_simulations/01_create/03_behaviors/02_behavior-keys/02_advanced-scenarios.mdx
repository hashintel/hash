...
slug: simulation/create/behaviors/behavior-keys/advanced-scenarios
...
You can find a full list of the built-in fields [here](/docs/simulations/create/anatomy-of-an-agent/state#reserved-fields). You do not need to define these in your behavior keys.
