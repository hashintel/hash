...
For an example that uses these statistics functions, see the example on the [Designing with Distributions](/docs/simulations/create/design-considerations/distributions) page.
