---
title: Statistics
slug: simulation/create/libraries/hash/javascript-libraries
...
For an example that uses these statistics functions, see the example on the [Designing with Distributions](/docs/simulations/create/advanced/designing-with-distributions) page.
