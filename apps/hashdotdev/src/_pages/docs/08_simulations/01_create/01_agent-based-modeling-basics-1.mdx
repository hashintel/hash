...
slug: simulation/create/agent-based-modeling-basics-1
...
**What took Conway weeks can now be done in seconds, and with HASH you can set up experiments, run analyses, and leverage the power of** [**cloud computing**](/docs/simulations/create/h.cloud) **directly in your browser, extending agent-based modeling to real-world problems and scenarios with ease.**
