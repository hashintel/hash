...
slug: simulation/create/experiments/experiment-types
...
<Hint style="info">
  Value sweeping is particularly is useful for multi-parameter sweeps and
...
<Hint style="info">
  Optimization experiments allow you to identify the best combination of
  parameters for minimizing or maximizing desired metrics.
</Hint>

Read more about [Optimization Experiments](/docs/simulations/create/experiments/optimization-experiments) in the next section of the docs.
