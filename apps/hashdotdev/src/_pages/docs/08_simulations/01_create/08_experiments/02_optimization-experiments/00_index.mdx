...
slug: simulation/create/experiments/optimization-experiments
...
<Hint style="info">
  ...
  metrics](/docs/simulations/create/views/analysis/metrics).
</Hint>
...
<Hint style="warning">
  ...
  Keys](/docs/simulations/create/behaviors/behavior-keys/) of your
