---
title: Experiments
slug: simulation/create/experiments
...
<Hint style="info">
  ...
  [hCloud](/docs/simulations/create/h.cloud)
</Hint>

For more information on specific syntax, read more about [Experiment Types](/docs/simulations/create/experiments/experiment-types).
