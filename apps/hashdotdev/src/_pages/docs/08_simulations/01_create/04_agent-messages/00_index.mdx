---
title: Messages
slug: simulation/create/agent-messages
objectId: 0d485ed3-efcc-4f4b-a8f0-0d886e688802
---

Information in a simulation can propagate in one of two ways - either through neighbors, which we cover in [Behaviors](/docs/simulations/create/behaviors/) and [Topology](/docs/simulations/create/configuration/topology/), or through message passing.
...
<Hint style="info">
  If you want to jump right into code you can take a look at our [Message
  Passing Colors](https://simulation.hash.ai/@hash/message-passing-colors) simulation, which demos message
  passing among many agents.
</Hint>
...
<Hint style="info">
  You can use the helper function state.addMessage\(to&lt;String&gt;,
  type&lt;String&gt;, data&lt;Dict&gt;\) to add messages directly to the
  state.messages field (the helper function can only take one agent as a "to"
  argument).
</Hint>
