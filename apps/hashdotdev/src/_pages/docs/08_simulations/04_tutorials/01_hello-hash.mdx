...
<Hint style="info">
  ...
  agents](/docs/simulations/create/agents) - you can
  reference and send messages through `agent_name`
</Hint>

Beneath the workspace's right-hand view-pane, you'll find the simulation control buttons. Click the **Reset** button \(circular arrow\) and then select the [Raw Output](/docs/simulations/run/simulation/outputs/raw-data#raw-output) tab in the viewer. Congratulations! You've given life to Alice and Bob.
