...
<Hint style="info">
  ...
  agents](/docs/simulation/creating-simulations/anatomy-of-an-agent) - you can
...
<Hint style="info">
  ...
  function_](/docs/simulation/creating-simulations/agent-messages/) _for
  pushing_ [_messages_](/docs/simulation/creating-simulations/agent-messages/)
