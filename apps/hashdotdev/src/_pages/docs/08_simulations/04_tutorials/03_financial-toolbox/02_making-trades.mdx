...
The agent can only modify its own **state**. To learn more about how behaviors work, we recommend you check out the [docs](https://hash.dev/docs/simulation/creating-simulations/anatomy-of-an-agent).
