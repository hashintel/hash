...
The agent can only modify its own **state**. To learn more about how behaviors work, we recommend you check out the [docs](https://hash.dev/docs/simulations/create/anatomy-of-an-agent).
