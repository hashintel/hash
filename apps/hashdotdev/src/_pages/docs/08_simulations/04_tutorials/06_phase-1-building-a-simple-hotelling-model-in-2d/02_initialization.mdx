...
Now, open up init.json. This is where we will be writing our [agent creator](/docs/simulations/create/agents/initial-state) that will generate all our simulation agents. First, generate the Customer agents.
