...
Start by opening our base template in either [JavaScript](https://simulation.hash.ai/@hash/getting-started-base) or [Python](https://simulation.hash.ai/@hash/getting-started-base-python) and forking it into your namespace.
