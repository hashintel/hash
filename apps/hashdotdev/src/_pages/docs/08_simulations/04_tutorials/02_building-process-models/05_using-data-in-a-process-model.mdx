...
<Hint style="info">
  ...
  [Datasets](/docs/simulation/creating-simulations/datasets/)
</Hint>
...
<Hint style="info">
  ...
  Distributions.](/docs/simulation/concepts/designing-with-distributions)
</Hint>
...
<Hint style="info">
  ...
  Model
  Concepts](/docs/simulation/concepts/designing-with-process-models/process-model-concepts)
</Hint>
