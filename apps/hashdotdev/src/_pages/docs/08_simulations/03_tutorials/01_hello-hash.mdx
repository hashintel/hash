...
<Hint style="info">
  ...
  agents](/docs/simulations/create/agents) - you can reference and send messages
  through `agent_name`
</Hint>
...
<Hint style="info">
  ...
  function_](/docs/simulations/create/agent-messages/) _for pushing_
  [_messages_](/docs/simulations/create/agent-messages/) _to the outgoing
  messages array._
</Hint>
