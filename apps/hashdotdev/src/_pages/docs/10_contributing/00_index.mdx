...
A lot of our code, and all newly written or updated JavaScript files, are [structured fractally](https://hash.dev/blog/file-structuring). You'll need to follow this pattern when contributing.
