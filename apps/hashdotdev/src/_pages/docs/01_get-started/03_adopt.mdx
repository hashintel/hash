...
[Flows](https://hash.ai/guide/flows) let you both outline workflows and automate actions, and can be combined with [Blocks](https://hash.ai/guide/blocks) to enable the development of whole [Apps](https://hash.ai/guide/apps) within HASH. 
