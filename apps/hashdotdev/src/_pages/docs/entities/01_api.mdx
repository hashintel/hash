...
**Write how to archive stuff via API**
...
In the future, we intend to introduce hard deletion. You can find this on the **\*\***\*\***\*\***\*\***\*\***\*\***\*\***product roadmap**\*\***\*\***\*\***\*\***\*\***\*\***\*\***. In general, we discourage the use of hard deletion in favor of archival or soft deletion, however its use may be required in order to maintain compliance with various regulations, policies or laws that you or your data may be subject to (for example, GDPR). In addition,
