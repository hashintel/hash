...
pub fn channel(
    ...
    let (entity_type_metadata_tx, entity_type_metadata_rx) =
        ontology::entity_type_metadata_channel(chunk_size, ontology_metadata_tx);
    let (entity_type_tx, entity_type_rx) =
        ontology::entity_type_channel(chunk_size, entity_type_metadata_tx);
        ...
        SnapshotRecordReceiver {
            stream: select_all(vec![
                ...
                ontology_metadata_rx
                    ...
                    .boxed(),
                entity_type_metadata_rx
                    .map(SnapshotRecordBatch::EntityTypeMetadata)
                    .boxed(),
