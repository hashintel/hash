import type { LlmMessage } from "./get-llm-response/llm-message.js";
import type { LlmToolDefinition } from "./get-llm-response/types.js";

export const judgeTestData = {
  messages: [
    {
      role: "user",
      parts: [
        ...
        },
        {
          fileData: {
            fileUri:
              "gs://hash-flow-files/files/f89989c3-c5b9-4662-9cff-651384f4a0da~4043537b-6fc0-4d1b-95b5-2c84d03e9bbf/0050a41f-113e-409c-a54c-d46d89ba103b/study_record_ISRCTN15438979_2025-01-20.pdf",
