...
import type { EntityUuid, Timestamp, Url, WebId } from "@blockprotocol/type-system";
...
const huntingPlcEntityClaims = [
  {
    ...
    subjectEntityLocalId: generateEntityId("66f93842-c6e0-4378-ab04-519edd7231af"),
...
const claimsAboutGraphicsCard: Claim[] = [
  {
    ...
    subjectEntityLocalId: generateEntityId("d705527d-59ed-462c-92c4-507b92095c22"),
    prepositionalPhrases: [],
    sources: [
      {
        type: "webpage",
