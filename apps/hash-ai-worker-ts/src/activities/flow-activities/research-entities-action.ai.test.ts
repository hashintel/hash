    ...
    const status = await researchEntitiesAction({
      inputs: [
        ...
        },
        {
          ...
          payload: {
            kind: "VersionedUrl",
            value: ["https://hash.ai/@h/types/entity-type/company/v/1"],
          },
        },
      ],
      testingParams: {
    ...
    const status = await researchEntitiesAction({
      inputs: [
        ...
        },
        {
          ...
          payload: {
            kind: "VersionedUrl",
            value: ["https://hash.ai/@h/types/entity-type/person/v/1"],
          },
        },
      ],
      testingParams: {
    ...
    const status = await researchEntitiesAction({
      inputs: [
        ...
        },
        {
          ...
          payload: {
            kind: "VersionedUrl",
            value: ["https://hash.ai/@h/types/entity-type/graphics-card/v/1"],
          },
        },
      ],
      testingParams: {
