...
export type EntityTypesContextValue = {
  ...
  isSpecialEntityTypeLookup: Record<VersionedUrl, SpecialEntityTypeRecord> | null;
  // for a given set of entityTypeIds, specify which special entity types apply to at least one of them
  includesSpecialEntityTypes: null | ((entityTypeIds: VersionedUrl[]) => SpecialEntityTypeRecord);
