...
import * as TileError from "./tile-document/error";
import * as Head from "./tile-document/head";
import * as Trailer from "./tile-document/trailer";
...
export type { TileDocumentErrorReason } from "./tile-document/error";
export { TileDocumentError } from "./tile-document/error";
export type {
  Bounds,
  Context,
  Coordinate,
  Mode,
  TileDocumentGlobal,
} from "./tile-document/head";
export type { TileDocumentTrailer } from "./tile-document/trailer";
