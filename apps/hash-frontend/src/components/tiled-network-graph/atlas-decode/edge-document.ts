...
import * as EdgeError from "./edge-document/error";
...
export type { EdgeDocumentErrorReason } from "./edge-document/error";
export { EdgeDocumentError } from "./edge-document/error";
