...
import { BlockQuote, Code, ListItem, OrderedList, Pre, UnorderedList } from "./markdown/elements";
...
const omitRefFromProps = <T extends { ref?: LegacyRef<unknown>; node?: unknown }>({
  ref: _ref,
  node: _node,
  ...props
...
const components: Partial<Components> = {
  ...
  h1: (props) => (
    <Typography variant="h1" {...omitRefFromProps(props)} sx={{ mt: 4, mb: 1.5, fontSize: 36 }} />
  ),
  h2: (props) => (
    <Typography variant="h2" {...omitRefFromProps(props)} sx={{ mt: 3.5, mb: 1.5, fontSize: 32 }} />
  ),
  h3: (props) => (
    <Typography variant="h3" {...omitRefFromProps(props)} sx={{ mt: 2.5, mb: 1.5, fontSize: 28 }} />
  ),
  h4: (props) => <Typography variant="h4" {...omitRefFromProps(props)} sx={{ mt: 2.5, mb: 1.5 }} />,
  h5: (props) => <Typography variant="h5" {...omitRefFromProps(props)} sx={{ mt: 2.5, mb: 1.5 }} />,
  h6: (props) => <Typography variant="h5" {...omitRefFromProps(props)} sx={{ mt: 2.5, mb: 1.5 }} />,
  img: (props) => (
  ...
  th: ({ align: _align, ...props }) => <TableCell {...omitRefFromProps(props)} sx={tableCellSx} />,
  td: ({ align: _align, ...props }) => <TableCell {...omitRefFromProps(props)} sx={tableCellSx} />,
