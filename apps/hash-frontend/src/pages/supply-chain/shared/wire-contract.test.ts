...
const seedRoot = fileURLToPath(
  new URL(
    "../../../../../../apps/hash-api/src/seed-data/supply-chain-demo/",
    import.meta.url,
  ),
);
...
function discoverFixtures(): {
  ...
  throw new Error(
    "No product fixture with a procurement and timing step was found in the supply-chain demo seed",
  );
}
...
function discoverSiteSlug(): string {
  ...
  if (!slug) {
    throw new Error("No site fixture found in the supply-chain demo seed");
  }
  return slug;
}
