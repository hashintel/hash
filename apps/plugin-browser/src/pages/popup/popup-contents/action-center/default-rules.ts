...
export const defaultRules: LocalStorage["automaticInferenceConfig"]["rules"] = [
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId:
      "https://hash.ai/@hash/types/entity-type/crunchbase-person/v/1",
  },
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId:
  ...
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId: "https://hash.ai/@hash/types/entity-type/acquired-entity/v/1",
  },
  {
    restrictToDomains: ["crunchbase.com"],
  ...
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId: "https://hash.ai/@hash/types/entity-type/primary-website/v/1",
  },
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId:
  ...
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId: "https://hash.ai/@hash/types/entity-type/stock-exchange/v/1",
  },
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId: "https://hash.ai/@hash/types/entity-type/is-operated-by/v/1",
  },
  {
    restrictToDomains: ["crunchbase.com"],
    entityTypeId: "https://hash.ai/@hash/types/entity-type/mentioned-in/v/1",
