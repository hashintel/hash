import { HashEntity, propertyObjectToPatches } from "@local/hash-graph-sdk/entity";
...
import type { EntityId, TypeIdsAndPropertiesForEntity } from "@blockprotocol/type-system";
...
export const updateEntity = <T extends TypeIdsAndPropertiesForEntity>(params: {
  ...
  queryGraphQlApi<UpdateEntityMutation, UpdateEntityMutationVariables>(updateEntityMutation, {
    entityUpdate: {
