...
import type { Entity, EntityId, OwnedById } from "@blockprotocol/type-system";
...
/**
 * Ideally we would use {@link extractOwnedByIdFromEntityId} from @blockprotocol/type-system/slim here,
