...
export const dereferencedPersonType = {
  ...
  schema: {
    ...
    labelProperty: "https://hash.ai/@h/types/property-type/name/" as BrandedUrl,
    links: {},
    properties: {
      name: {
  ...
  simplifiedPropertyTypeMappings: {
    name: "https://hash.ai/@h/types/property-type/name/" as BrandedUrl,
    email: "https://hash.ai/@h/types/property-type/email/" as BrandedUrl,
    bio: "https://hash.ai/@h/types/property-type/bio/" as BrandedUrl,
    "website-url":
    ...
    "date-of-birth":
      "https://hash.ai/@h/types/property-type/date-of-birth/" as BrandedUrl,
    "job-title":
      "https://hash.ai/@h/types/property-type/job-title/" as BrandedUrl,
  },
