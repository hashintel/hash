...
export const zDereferencedPropertyType = z
  .object({
...
export const zDereferencedEntityTypeWithSimplifiedKeys = z
  .object({
    ...
    schema: zDereferencedEntityType,
...
type DereferencedPropertyType = z.infer<typeof zDereferencedPropertyType>;
...
export interface DereferencedEntityType<K extends string | BaseUrl = BaseUrl>
  extends Pick<
    EntityType,
