...
/**
 * Dereferenced Person entity type with simplified property keys.
 *
 * Properties:
 ...
 */
export const dereferencedPersonType: DereferencedEntityTypeWithSimplifiedKeys =
  {
    isLink: false,
    ...
    schema: {
      ...
      labelProperty: "https://hash.ai/@h/types/property-type/name/" as const,
      links: {},
      properties: {
        name: {
    ...
    simplifiedPropertyTypeMappings: {
      name: "https://hash.ai/@h/types/property-type/name/" as const,
      email: "https://hash.ai/@h/types/property-type/email/" as const,
      bio: "https://hash.ai/@h/types/property-type/bio/" as const,
      "website-url":
        "https://hash.ai/@h/types/property-type/website-url/" as const,
      location: "https://hash.ai/@h/types/property-type/location/" as const,
      "date-of-birth":
        "https://hash.ai/@h/types/property-type/date-of-birth/" as const,
      "job-title": "https://hash.ai/@h/types/property-type/job-title/" as const,
    },
