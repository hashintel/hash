 ...
 */
export const dereferencedOrganizationType: DereferencedEntityTypeWithSimplifiedKeys =
  {
    isLink: false,
    ...
    schema: {
      ...
      labelProperty:
        "https://hash.ai/@h/types/property-type/organization-name/" as const,
      links: {},
      properties: {
        "organization-name": {
    ...
    simplifiedPropertyTypeMappings: {
      "organization-name":
        "https://hash.ai/@h/types/property-type/organization-name/" as const,
      description:
        "https://hash.ai/@h/types/property-type/description/" as const,
      "website-url":
        "https://hash.ai/@h/types/property-type/website-url/" as const,
      location: "https://hash.ai/@h/types/property-type/location/" as const,
      "founded-on":
        "https://hash.ai/@h/types/property-type/founded-on/" as const,
      industry: "https://hash.ai/@h/types/property-type/industry/" as const,
      shortname: "https://hash.ai/@h/types/property-type/shortname/" as const,
    },
