...
const zodPersonSchema = convertJsonSchemaToZod(dereferencedPersonSchema.schema as unknown as JZSchema);
...
z.toJSONSchema(z.object({ foo: z.string(), bar: z.number(), web: z.httpUrl() }).array()); // ?
