  ...
  const blocks: CreateBlockArgs[] = [
    {
      ...
      blockEntity: results.get("text1")!,
      createdBy: user,
    },
    {
      resultsKey: "b2",
      componentId: "https://block.blockprotocol.org/paragraph",
      blockEntity: results.get("text2")!,
      createdBy: user,
    },
    {
      resultsKey: "b3",
      componentId: "https://block.blockprotocol.org/paragraph",
      blockEntity: results.get("text3")!,
      createdBy: user,
    },
    {
      resultsKey: "b4",
      componentId: "https://block.blockprotocol.org/table",
      blockEntity: results.get("t1")!,
      createdBy: user,
    },
    {
      resultsKey: "b5",
      componentId: "https://block.blockprotocol.org/header",
      blockEntity: results.get("text5")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
    ...
    },
    {
      resultsKey: "b10",
      componentId: "https://block.blockprotocol.org/header",
      blockEntity: results.get("header1text")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
      ...
      blockEntity: results.get("divider1")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
      ...
      blockEntity: results.get("embed1")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
      resultsKey: "b13",
      componentId: "https://block.blockprotocol.org/embed",
      blockEntity: results.get("embed2")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
    ...
    },
    {
      ...
      blockEntity: results.get("video1")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
      resultsKey: "b17",
      componentId: "https://block.blockprotocol.org/header",
      blockEntity: results.get("header2text")!,
      createdBy: user,
      accountId: systemOrg.accountId,
    },
    {
