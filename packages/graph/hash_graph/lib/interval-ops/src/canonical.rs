...
impl<T: PartialOrd, I: Interval<T>> Add<I> for CanonicalInterval<T> {
    type Output = Self;
...
impl<T: PartialOrd, I: Interval<T>> Sub<I> for CanonicalInterval<T> {
    type Output = Self;
...
impl<T: PartialOrd, I: Interval<T>> Mul<I> for CanonicalInterval<T> {
    type Output = Self;
