...
pub const EMAIL_V1: &str = include_str!("email.json");
pub const FAVORITE_FILM_V1: &str = include_str!("favorite_film.json");
...
pub const POSTCODE_NUMBER_V1: &str = include_str!("postcode.json");
pub const PUBLISHED_ON_V1: &str = include_str!("published_on.json");
