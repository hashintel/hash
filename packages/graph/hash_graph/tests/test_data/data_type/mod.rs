...
pub const EMPTY_LIST_V1: &str = include_str!("empty-list.json");
pub const NULL_V1: &str = include_str!("null.json");
pub const NUMBER_V1: &str = include_str!("number.json");
pub const OBJECT_V1: &str = include_str!("object-v1.json");
pub const OBJECT_V2: &str = include_str!("object-v2.json");
