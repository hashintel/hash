...
//! [![rust-version](https://img.shields.io/static/v1?label=Rust&message=1.63.0/nightly-2022-12-09&color=blue)][rust-version]
...
mod error;
#[cfg(any(feature = "std", feature = "hooks", feature = "color"))]
pub mod fmt;
#[cfg(not(any(feature = "std", feature = "hooks", feature = "color")))]
mod fmt;
