...
- Frames now provide [`Location`](https://doc.rust-lang.org/stable/std/panic/struct.Location.html) on nightly via the [`Provider`](https://doc.rust-lang.org/stable/std/any/trait.Provider.html) API ([#1237](https://github.com/hashintel/hash/pull/1237))
