...
- Deprecate `Frame::location` in favor of an additional attachment on context change/creation (will be added in 0.3) ([#1311](https://github.com/hashintel/hash/pull/1311))
