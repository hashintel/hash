...
const behavior = (state, context) => {
  ...
  state.set("o1_is_struct", typeof o1 === "object");
  ...
  // object
  state["o1_o1_is_struct"] = typeof o1["o1"] === "object";
  ...
  // list
  state["o1_l1_is_list"] = typeof o1["l1"] === "object";
  state["o1_l1_0_is_number"] = typeof o1["l1"][0] === "number";

  o1["l2"] = o1["l1"].concat(4);
  o1["l1"].unshift(0);

  state["o1_l2_is_list"] = typeof o1["l2"] === "object";
  state["o1_l2_0_is_number"] = typeof o1["l2"][0] === "number";

  // fixed size list
  state["o1_f1_is_list"] = typeof o1["f1"] === "object";
  ...
  state["o1_f2_is_list"] = typeof o1["f2"] === "object";
