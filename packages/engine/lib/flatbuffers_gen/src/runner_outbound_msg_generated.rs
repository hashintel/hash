...
use crate::sync_state_interim_generated::*;
use crate::user_errors_generated::*;
use crate::metaversion_generated::*;
use crate::user_warnings_generated::*;
use crate::user_warning_generated::*;
use crate::runner_errors_generated::*;
use crate::package_error_generated::*;
use crate::runner_warning_generated::*;
use crate::runner_error_generated::*;
use crate::task_msg_generated::*;
use crate::user_error_generated::*;
use crate::batch_generated::*;
use crate::serialized_generated::*;
use crate::runner_warnings_generated::*;
...
impl<'a> TaskCancelled<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args TaskCancelledArgs<'args>) -> flatbuffers::WIPOffset<TaskCancelled<'bldr>> {
...
impl<'a: 'b, 'b> TaskCancelledBuilder<'a, 'b> {
  ...
  pub fn add_task_id(&mut self, task_id: &TaskId) {
    self.fbb_.push_slot_always::<&TaskId>(TaskCancelled::VT_TASK_ID, task_id);
  }
  #[inline]
...
impl<'a> RunnerOutboundMsg<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args RunnerOutboundMsgArgs) -> flatbuffers::WIPOffset<RunnerOutboundMsg<'bldr>> {
  ...
  pub fn sim_sid(&self) -> u32 {
    self._tab.get::<u32>(RunnerOutboundMsg::VT_SIM_SID, Some(0)).unwrap()
  }
  #[inline]
  pub fn payload_type(&self) -> RunnerOutboundMsgPayload {
    self._tab.get::<RunnerOutboundMsgPayload>(RunnerOutboundMsg::VT_PAYLOAD_TYPE, Some(RunnerOutboundMsgPayload::NONE)).unwrap()
  }
  #[inline]
  pub fn payload(&self) -> flatbuffers::Table<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(RunnerOutboundMsg::VT_PAYLOAD, None).unwrap()
  }
  #[inline]
...
impl flatbuffers::Verifiable for RunnerOutboundMsg<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<RunnerOutboundMsgPayload, _>(&"payload_type", Self::VT_PAYLOAD_TYPE, &"payload", Self::VT_PAYLOAD, true, |key, v, pos| {
        match key {
          RunnerOutboundMsgPayload::TaskMsg => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TaskMsg>>("RunnerOutboundMsgPayload::TaskMsg", pos),
          RunnerOutboundMsgPayload::TaskCancelled => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TaskCancelled>>("RunnerOutboundMsgPayload::TaskCancelled", pos),
          RunnerOutboundMsgPayload::RunnerError => v.verify_union_variant::<flatbuffers::ForwardsUOffset<RunnerError>>("RunnerOutboundMsgPayload::RunnerError", pos),
          RunnerOutboundMsgPayload::RunnerErrors => v.verify_union_variant::<flatbuffers::ForwardsUOffset<RunnerErrors>>("RunnerOutboundMsgPayload::RunnerErrors", pos),
          RunnerOutboundMsgPayload::RunnerWarning => v.verify_union_variant::<flatbuffers::ForwardsUOffset<RunnerWarning>>("RunnerOutboundMsgPayload::RunnerWarning", pos),
          RunnerOutboundMsgPayload::RunnerWarnings => v.verify_union_variant::<flatbuffers::ForwardsUOffset<RunnerWarnings>>("RunnerOutboundMsgPayload::RunnerWarnings", pos),
          RunnerOutboundMsgPayload::PackageError => v.verify_union_variant::<flatbuffers::ForwardsUOffset<PackageError>>("RunnerOutboundMsgPayload::PackageError", pos),
          RunnerOutboundMsgPayload::UserErrors => v.verify_union_variant::<flatbuffers::ForwardsUOffset<UserErrors>>("RunnerOutboundMsgPayload::UserErrors", pos),
          RunnerOutboundMsgPayload::UserWarnings => v.verify_union_variant::<flatbuffers::ForwardsUOffset<UserWarnings>>("RunnerOutboundMsgPayload::UserWarnings", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b> RunnerOutboundMsgBuilder<'a, 'b> {
  ...
  pub fn add_sim_sid(&mut self, sim_sid: u32) {
    self.fbb_.push_slot::<u32>(RunnerOutboundMsg::VT_SIM_SID, sim_sid, 0);
  }
  #[inline]
  pub fn add_payload_type(&mut self, payload_type: RunnerOutboundMsgPayload) {
    self.fbb_.push_slot::<RunnerOutboundMsgPayload>(RunnerOutboundMsg::VT_PAYLOAD_TYPE, payload_type, RunnerOutboundMsgPayload::NONE);
  }
  #[inline]
  pub fn add_payload(&mut self, payload: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RunnerOutboundMsg::VT_PAYLOAD, payload);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RunnerOutboundMsgBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<RunnerOutboundMsg<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, RunnerOutboundMsg::VT_PAYLOAD,"payload");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub fn root_as_runner_outbound_msg(buf: &[u8]) -> Result<RunnerOutboundMsg, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_runner_outbound_msg(buf: &[u8]) -> Result<RunnerOutboundMsg, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a RunnerOutboundMsg and returns it.
/// # Safety
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed RunnerOutboundMsg and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_runner_outbound_msg_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<RunnerOutboundMsg<'a>>) {
