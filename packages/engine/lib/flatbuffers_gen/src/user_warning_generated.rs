...
impl<'a> UserWarning<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args UserWarningArgs<'args>) -> flatbuffers::WIPOffset<UserWarning<'bldr>> {
  ...
  pub fn msg(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(UserWarning::VT_MSG, None).unwrap()
  }
  #[inline]
  pub fn details(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(UserWarning::VT_DETAILS, None)
  }
}
...
impl<'a: 'b, 'b> UserWarningBuilder<'a, 'b> {
  ...
  pub fn add_msg(&mut self, msg: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UserWarning::VT_MSG, msg);
  }
  #[inline]
  pub fn add_details(&mut self, details: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UserWarning::VT_DETAILS, details);
  }
  #[inline]
...
pub fn size_prefixed_root_as_user_warning(buf: &[u8]) -> Result<UserWarning, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed UserWarning and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_user_warning_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<UserWarning<'a>>) {
