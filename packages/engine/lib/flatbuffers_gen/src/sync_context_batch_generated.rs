...
impl<'a> ContextBatchSync<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args ContextBatchSyncArgs<'args>) -> flatbuffers::WIPOffset<ContextBatchSync<'bldr>> {
      let mut builder = ContextBatchSyncBuilder::new(_fbb);
      builder.add_current_step(args.current_step);
      if let Some(x) = args.context_batch { builder.add_context_batch(x); }
      builder.finish()
    }
  ...
  pub fn context_batch(&self) -> Batch<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Batch>>(ContextBatchSync::VT_CONTEXT_BATCH, None).unwrap()
  }
  #[inline]
  pub fn current_step(&self) -> i64 {
    self._tab.get::<i64>(ContextBatchSync::VT_CURRENT_STEP, Some(0)).unwrap()
  }
}
...
impl flatbuffers::Verifiable for ContextBatchSync<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<Batch>>(&"context_batch", Self::VT_CONTEXT_BATCH, true)?
...
impl<'a: 'b, 'b> ContextBatchSyncBuilder<'a, 'b> {
  ...
  pub fn add_context_batch(&mut self, context_batch: flatbuffers::WIPOffset<Batch<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Batch>>(ContextBatchSync::VT_CONTEXT_BATCH, context_batch);
  }
  #[inline]
  pub fn add_current_step(&mut self, current_step: i64) {
    self.fbb_.push_slot::<i64>(ContextBatchSync::VT_CURRENT_STEP, current_step, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ContextBatchSyncBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<ContextBatchSync<'a>> {
    ...
    self.fbb_.required(o, ContextBatchSync::VT_CONTEXT_BATCH,"context_batch");
...
pub fn root_as_context_batch_sync(buf: &[u8]) -> Result<ContextBatchSync, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_context_batch_sync(buf: &[u8]) -> Result<ContextBatchSync, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a ContextBatchSync and returns it.
/// # Safety
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed ContextBatchSync and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_context_batch_sync_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<ContextBatchSync<'a>>) {
