...
impl<'a> Batch<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args BatchArgs<'args>) -> flatbuffers::WIPOffset<Batch<'bldr>> {
      let mut builder = BatchBuilder::new(_fbb);
      if let Some(x) = args.metaversion { builder.add_metaversion(x); }
  ...
  pub fn batch_id(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Batch::VT_BATCH_ID, None).unwrap()
  }
  #[inline]
  pub fn metaversion(&self) -> Metaversion<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Metaversion>>(Batch::VT_METAVERSION, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for Batch<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"batch_id", Self::VT_BATCH_ID, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<Metaversion>>(&"metaversion", Self::VT_METAVERSION, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> BatchBuilder<'a, 'b> {
  ...
  pub fn add_batch_id(&mut self, batch_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Batch::VT_BATCH_ID, batch_id);
  }
  #[inline]
  pub fn add_metaversion(&mut self, metaversion: flatbuffers::WIPOffset<Metaversion<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Metaversion>>(Batch::VT_METAVERSION, metaversion);
  }
  #[inline]
...
#[inline]
pub fn finish_size_prefixed_batch_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<Batch<'a>>) {
