...
impl<'a> StateSnapshotSync<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args StateSnapshotSyncArgs<'args>) -> flatbuffers::WIPOffset<StateSnapshotSync<'bldr>> {
      let mut builder = StateSnapshotSyncBuilder::new(_fbb);
      builder.add_current_step(args.current_step);
      if let Some(x) = args.message_pool { builder.add_message_pool(x); }
      if let Some(x) = args.agent_pool { builder.add_agent_pool(x); }
      builder.finish()
    }
  ...
  pub fn agent_pool(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch>>>>(StateSnapshotSync::VT_AGENT_POOL, None).unwrap()
  }
  #[inline]
  pub fn message_pool(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch>>>>(StateSnapshotSync::VT_MESSAGE_POOL, None).unwrap()
  }
  #[inline]
  pub fn current_step(&self) -> i64 {
    self._tab.get::<i64>(StateSnapshotSync::VT_CURRENT_STEP, Some(0)).unwrap()
  }
}
...
impl flatbuffers::Verifiable for StateSnapshotSync<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Batch>>>>(&"agent_pool", Self::VT_AGENT_POOL, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Batch>>>>(&"message_pool", Self::VT_MESSAGE_POOL, true)?
...
pub struct StateSnapshotSyncArgs<'a> {
    pub agent_pool: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>>>>,
    pub message_pool: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>>>>,
...
impl<'a: 'b, 'b> StateSnapshotSyncBuilder<'a, 'b> {
  #[inline]
  pub fn add_agent_pool(&mut self, agent_pool: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Batch<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StateSnapshotSync::VT_AGENT_POOL, agent_pool);
  }
  #[inline]
  pub fn add_message_pool(&mut self, message_pool: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Batch<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StateSnapshotSync::VT_MESSAGE_POOL, message_pool);
  }
  #[inline]
  pub fn add_current_step(&mut self, current_step: i64) {
    self.fbb_.push_slot::<i64>(StateSnapshotSync::VT_CURRENT_STEP, current_step, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> StateSnapshotSyncBuilder<'a, 'b> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<StateSnapshotSync<'a>> {
    ...
    self.fbb_.required(o, StateSnapshotSync::VT_AGENT_POOL,"agent_pool");
    self.fbb_.required(o, StateSnapshotSync::VT_MESSAGE_POOL,"message_pool");
...
pub fn root_as_state_snapshot_sync(buf: &[u8]) -> Result<StateSnapshotSync, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_state_snapshot_sync(buf: &[u8]) -> Result<StateSnapshotSync, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a StateSnapshotSync and returns it.
/// # Safety
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed StateSnapshotSync and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_state_snapshot_sync_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<StateSnapshotSync<'a>>) {
