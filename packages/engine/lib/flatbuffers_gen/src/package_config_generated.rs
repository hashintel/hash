...
impl<'a> Package<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
      ...
      if let Some(x) = args.init_payload { builder.add_init_payload(x); }
  ...
  pub fn type_(&self) -> PackageType {
    self._tab.get::<PackageType>(Package::VT_TYPE_, Some(PackageType::Init)).unwrap()
  }
  #[inline]
  pub fn name(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Package::VT_NAME, None).unwrap()
  }
  #[inline]
  pub fn sid(&self) -> u64 {
  ...
  pub fn init_payload(&self) -> Option<Serialized<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Serialized>>(Package::VT_INIT_PAYLOAD, None)
  }
}
...
impl flatbuffers::Verifiable for Package<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<Serialized>>(&"init_payload", Self::VT_INIT_PAYLOAD, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> PackageBuilder<'a, 'b> {
  ...
  pub fn add_type_(&mut self, type_: PackageType) {
    self.fbb_.push_slot::<PackageType>(Package::VT_TYPE_, type_, PackageType::Init);
  }
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Package::VT_NAME, name);
  }
  #[inline]
  ...
  pub fn add_init_payload(&mut self, init_payload: flatbuffers::WIPOffset<Serialized<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Serialized>>(Package::VT_INIT_PAYLOAD, init_payload);
  }
  #[inline]
...
impl<'a> PackageConfig<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args PackageConfigArgs<'args>) -> flatbuffers::WIPOffset<PackageConfig<'bldr>> {
  ...
  pub fn packages(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Package<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Package>>>>(PackageConfig::VT_PACKAGES, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for PackageConfig<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Package>>>>(&"packages", Self::VT_PACKAGES, true)?
     .finish();
    Ok(())
  }
}
pub struct PackageConfigArgs<'a> {
    pub packages: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Package<'a>>>>>,
}
...
impl<'a: 'b, 'b> PackageConfigBuilder<'a, 'b> {
  #[inline]
  pub fn add_packages(&mut self, packages: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Package<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(PackageConfig::VT_PACKAGES, packages);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<PackageConfig<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, PackageConfig::VT_PACKAGES,"packages");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub fn size_prefixed_root_as_package_config(buf: &[u8]) -> Result<PackageConfig, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_package_config_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<PackageConfig<'a>>) {
