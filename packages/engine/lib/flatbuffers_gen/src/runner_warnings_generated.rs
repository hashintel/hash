...
impl<'a> RunnerWarnings<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args RunnerWarningsArgs<'args>) -> flatbuffers::WIPOffset<RunnerWarnings<'bldr>> {
  ...
  #[inline]
  pub fn inner(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RunnerWarning<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RunnerWarning>>>>(RunnerWarnings::VT_INNER, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for RunnerWarnings<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RunnerWarning>>>>(&"inner", Self::VT_INNER, true)?
     .finish();
    Ok(())
  }
}
pub struct RunnerWarningsArgs<'a> {
    pub inner: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RunnerWarning<'a>>>>>,
}
...
impl<'a: 'b, 'b> RunnerWarningsBuilder<'a, 'b> {
  #[inline]
  pub fn add_inner(&mut self, inner: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<RunnerWarning<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RunnerWarnings::VT_INNER, inner);
  }
  #[inline]
...
pub fn root_as_runner_warnings(buf: &[u8]) -> Result<RunnerWarnings, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_runner_warnings(buf: &[u8]) -> Result<RunnerWarnings, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed RunnerWarnings and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_runner_warnings_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<RunnerWarnings<'a>>) {
