...
impl<'a> TaskMsg<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args TaskMsgArgs<'args>) -> flatbuffers::WIPOffset<TaskMsg<'bldr>> {
      let mut builder = TaskMsgBuilder::new(_fbb);
      builder.add_package_sid(args.package_sid);
      if let Some(x) = args.payload { builder.add_payload(x); }
      if let Some(x) = args.metaversioning { builder.add_metaversioning(x); }
  ...
  pub fn package_sid(&self) -> u64 {
    self._tab.get::<u64>(TaskMsg::VT_PACKAGE_SID, Some(0)).unwrap()
  }
  #[inline]
  ...
  pub fn target(&self) -> Target {
    self._tab.get::<Target>(TaskMsg::VT_TARGET, Some(Target::Python)).unwrap()
  }
  #[inline]
  pub fn metaversioning(&self) -> Option<StateInterimSync<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<StateInterimSync>>(TaskMsg::VT_METAVERSIONING, None)
  }
  #[inline]
  pub fn payload(&self) -> Serialized<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<Serialized>>(TaskMsg::VT_PAYLOAD, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for TaskMsg<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<Serialized>>(&"payload", Self::VT_PAYLOAD, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> TaskMsgBuilder<'a, 'b> {
  ...
  pub fn add_package_sid(&mut self, package_sid: u64) {
    self.fbb_.push_slot::<u64>(TaskMsg::VT_PACKAGE_SID, package_sid, 0);
  }
  #[inline]
  pub fn add_task_id(&mut self, task_id: &TaskId) {
    self.fbb_.push_slot_always::<&TaskId>(TaskMsg::VT_TASK_ID, task_id);
  }
  #[inline]
  pub fn add_target(&mut self, target: Target) {
    self.fbb_.push_slot::<Target>(TaskMsg::VT_TARGET, target, Target::Python);
  }
  #[inline]
  pub fn add_metaversioning(&mut self, metaversioning: flatbuffers::WIPOffset<StateInterimSync<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<StateInterimSync>>(TaskMsg::VT_METAVERSIONING, metaversioning);
  }
  #[inline]
  pub fn add_payload(&mut self, payload: flatbuffers::WIPOffset<Serialized<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Serialized>>(TaskMsg::VT_PAYLOAD, payload);
  }
  #[inline]
