...
impl<'a> RunnerErrors<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args RunnerErrorsArgs<'args>) -> flatbuffers::WIPOffset<RunnerErrors<'bldr>> {
  ...
  pub fn inner(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RunnerError<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RunnerError>>>>(RunnerErrors::VT_INNER, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for RunnerErrors<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RunnerError>>>>(&"inner", Self::VT_INNER, true)?
     .finish();
    Ok(())
  }
}
pub struct RunnerErrorsArgs<'a> {
    pub inner: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RunnerError<'a>>>>>,
}
...
impl<'a: 'b, 'b> RunnerErrorsBuilder<'a, 'b> {
  #[inline]
  pub fn add_inner(&mut self, inner: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<RunnerError<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RunnerErrors::VT_INNER, inner);
  }
  #[inline]
...
pub fn size_prefixed_root_as_runner_errors(buf: &[u8]) -> Result<RunnerErrors, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_runner_errors_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<RunnerErrors<'a>>) {
