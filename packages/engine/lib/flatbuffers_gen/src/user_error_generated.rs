...
impl<'a> UserError<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args UserErrorArgs<'args>) -> flatbuffers::WIPOffset<UserError<'bldr>> {
  ...
  pub fn msg(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(UserError::VT_MSG, None)
  }
}
...
impl<'a: 'b, 'b> UserErrorBuilder<'a, 'b> {
  ...
  pub fn add_msg(&mut self, msg: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UserError::VT_MSG, msg);
  }
  #[inline]
...
pub fn size_prefixed_root_as_user_error(buf: &[u8]) -> Result<UserError, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed UserError and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_user_error_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<UserError<'a>>) {
