...
impl<'a> CancelTask<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args CancelTaskArgs<'args>) -> flatbuffers::WIPOffset<CancelTask<'bldr>> {
...
impl<'a: 'b, 'b> CancelTaskBuilder<'a, 'b> {
  ...
  pub fn add_task_id(&mut self, task_id: &TaskId) {
    self.fbb_.push_slot_always::<&TaskId>(CancelTask::VT_TASK_ID, task_id);
  }
  #[inline]
...
impl<'a> TerminateRunner<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        _args: &'args TerminateRunnerArgs) -> flatbuffers::WIPOffset<TerminateRunner<'bldr>> {
...
impl<'a> TerminateSimulationRun<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        _args: &'args TerminateSimulationRunArgs) -> flatbuffers::WIPOffset<TerminateSimulationRun<'bldr>> {
...
impl<'a: 'b, 'b> TerminateSimulationRunBuilder<'a, 'b> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> TerminateSimulationRunBuilder<'a, 'b> {
    let start = _fbb.start_table();
...
impl<'a> RunnerInboundMsg<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args RunnerInboundMsgArgs) -> flatbuffers::WIPOffset<RunnerInboundMsg<'bldr>> {
  ...
  pub fn sim_sid(&self) -> u32 {
    self._tab.get::<u32>(RunnerInboundMsg::VT_SIM_SID, Some(0)).unwrap()
  }
  #[inline]
  pub fn payload_type(&self) -> RunnerInboundMsgPayload {
    self._tab.get::<RunnerInboundMsgPayload>(RunnerInboundMsg::VT_PAYLOAD_TYPE, Some(RunnerInboundMsgPayload::NONE)).unwrap()
  }
  #[inline]
  pub fn payload(&self) -> flatbuffers::Table<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(RunnerInboundMsg::VT_PAYLOAD, None).unwrap()
  }
  #[inline]
...
impl flatbuffers::Verifiable for RunnerInboundMsg<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<RunnerInboundMsgPayload, _>(&"payload_type", Self::VT_PAYLOAD_TYPE, &"payload", Self::VT_PAYLOAD, true, |key, v, pos| {
        match key {
          RunnerInboundMsgPayload::TaskMsg => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TaskMsg>>("RunnerInboundMsgPayload::TaskMsg", pos),
          RunnerInboundMsgPayload::CancelTask => v.verify_union_variant::<flatbuffers::ForwardsUOffset<CancelTask>>("RunnerInboundMsgPayload::CancelTask", pos),
          RunnerInboundMsgPayload::StateSync => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StateSync>>("RunnerInboundMsgPayload::StateSync", pos),
          RunnerInboundMsgPayload::StateSnapshotSync => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StateSnapshotSync>>("RunnerInboundMsgPayload::StateSnapshotSync", pos),
          RunnerInboundMsgPayload::ContextBatchSync => v.verify_union_variant::<flatbuffers::ForwardsUOffset<ContextBatchSync>>("RunnerInboundMsgPayload::ContextBatchSync", pos),
          RunnerInboundMsgPayload::StateInterimSync => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StateInterimSync>>("RunnerInboundMsgPayload::StateInterimSync", pos),
          RunnerInboundMsgPayload::TerminateSimulationRun => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TerminateSimulationRun>>("RunnerInboundMsgPayload::TerminateSimulationRun", pos),
          RunnerInboundMsgPayload::TerminateRunner => v.verify_union_variant::<flatbuffers::ForwardsUOffset<TerminateRunner>>("RunnerInboundMsgPayload::TerminateRunner", pos),
          RunnerInboundMsgPayload::NewSimulationRun => v.verify_union_variant::<flatbuffers::ForwardsUOffset<NewSimulationRun>>("RunnerInboundMsgPayload::NewSimulationRun", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a: 'b, 'b> RunnerInboundMsgBuilder<'a, 'b> {
  ...
  pub fn add_sim_sid(&mut self, sim_sid: u32) {
    self.fbb_.push_slot::<u32>(RunnerInboundMsg::VT_SIM_SID, sim_sid, 0);
  }
  #[inline]
  pub fn add_payload_type(&mut self, payload_type: RunnerInboundMsgPayload) {
    self.fbb_.push_slot::<RunnerInboundMsgPayload>(RunnerInboundMsg::VT_PAYLOAD_TYPE, payload_type, RunnerInboundMsgPayload::NONE);
  }
  #[inline]
  pub fn add_payload(&mut self, payload: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RunnerInboundMsg::VT_PAYLOAD, payload);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RunnerInboundMsgBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<RunnerInboundMsg<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, RunnerInboundMsg::VT_PAYLOAD,"payload");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub fn root_as_runner_inbound_msg(buf: &[u8]) -> Result<RunnerInboundMsg, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_runner_inbound_msg(buf: &[u8]) -> Result<RunnerInboundMsg, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_runner_inbound_msg_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<RunnerInboundMsg<'a>>) {
