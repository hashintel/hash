...
impl<'a> Serialized<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args SerializedArgs<'args>) -> flatbuffers::WIPOffset<Serialized<'bldr>> {
  ...
  pub fn inner(&self) -> &'a [u8] {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(Serialized::VT_INNER, None).map(|v| v.safe_slice()).unwrap()
  }
}
...
impl flatbuffers::Verifiable for Serialized<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"inner", Self::VT_INNER, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> SerializedBuilder<'a, 'b> {
  ...
  pub fn add_inner(&mut self, inner: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Serialized::VT_INNER, inner);
  }
  #[inline]
...
pub fn size_prefixed_root_as_serialized(buf: &[u8]) -> Result<Serialized, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_serialized_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<Serialized<'a>>) {
