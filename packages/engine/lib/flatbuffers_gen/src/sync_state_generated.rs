...
impl<'a> StateSync<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args StateSyncArgs<'args>) -> flatbuffers::WIPOffset<StateSync<'bldr>> {
  ...
  pub fn agent_pool(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch>>>>(StateSync::VT_AGENT_POOL, None).unwrap()
  }
  #[inline]
  pub fn message_pool(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch>>>>(StateSync::VT_MESSAGE_POOL, None).unwrap()
  }
  #[inline]
  pub fn current_step(&self) -> i64 {
    self._tab.get::<i64>(StateSync::VT_CURRENT_STEP, Some(0)).unwrap()
  }
}
...
impl<'a: 'b, 'b> StateSyncBuilder<'a, 'b> {
  ...
  pub fn add_agent_pool(&mut self, agent_pool: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Batch<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StateSync::VT_AGENT_POOL, agent_pool);
  }
  #[inline]
  pub fn add_message_pool(&mut self, message_pool: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Batch<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StateSync::VT_MESSAGE_POOL, message_pool);
  }
  #[inline]
  pub fn add_current_step(&mut self, current_step: i64) {
    self.fbb_.push_slot::<i64>(StateSync::VT_CURRENT_STEP, current_step, 0);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<StateSync<'a>> {
    ...
    self.fbb_.required(o, StateSync::VT_AGENT_POOL,"agent_pool");
    self.fbb_.required(o, StateSync::VT_MESSAGE_POOL,"message_pool");
...
pub fn size_prefixed_root_as_state_sync(buf: &[u8]) -> Result<StateSync, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed StateSync and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_state_sync_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<StateSync<'a>>) {
