...
impl<'a> Init<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args InitArgs<'args>) -> flatbuffers::WIPOffset<Init<'bldr>> {
      ...
      if let Some(x) = args.experiment_id { builder.add_experiment_id(x); }
      builder.finish()
    }
  ...
  pub fn worker_index(&self) -> u64 {
    self._tab.get::<u64>(Init::VT_WORKER_INDEX, Some(0)).unwrap()
  }
  #[inline]
  pub fn shared_context(&self) -> SharedContext<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<SharedContext>>(Init::VT_SHARED_CONTEXT, None).unwrap()
  }
  #[inline]
  pub fn package_config(&self) -> PackageConfig<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<PackageConfig>>(Init::VT_PACKAGE_CONFIG, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for Init<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<SharedContext>>(&"shared_context", Self::VT_SHARED_CONTEXT, true)?
...
impl<'a: 'b, 'b> InitBuilder<'a, 'b> {
  ...
  pub fn add_experiment_id(&mut self, experiment_id: &ExperimentId) {
    self.fbb_.push_slot_always::<&ExperimentId>(Init::VT_EXPERIMENT_ID, experiment_id);
  }
  #[inline]
  pub fn add_worker_index(&mut self, worker_index: u64) {
    self.fbb_.push_slot::<u64>(Init::VT_WORKER_INDEX, worker_index, 0);
  }
  #[inline]
  pub fn add_shared_context(&mut self, shared_context: flatbuffers::WIPOffset<SharedContext<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<SharedContext>>(Init::VT_SHARED_CONTEXT, shared_context);
  }
  #[inline]
  pub fn add_package_config(&mut self, package_config: flatbuffers::WIPOffset<PackageConfig<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<PackageConfig>>(Init::VT_PACKAGE_CONFIG, package_config);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<Init<'a>> {
    ...
    self.fbb_.required(o, Init::VT_SHARED_CONTEXT,"shared_context");
    self.fbb_.required(o, Init::VT_PACKAGE_CONFIG,"package_config");
