...
use crate::metaversion_generated::*;
use crate::shared_context_generated::*;
use crate::package_config_generated::*;
use crate::batch_generated::*;
use crate::serialized_generated::*;
use std::mem;
...
impl<'a> DatastoreInit<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args DatastoreInitArgs<'args>) -> flatbuffers::WIPOffset<DatastoreInit<'bldr>> {
      let mut builder = DatastoreInitBuilder::new(_fbb);
      if let Some(x) = args.shared_context { builder.add_shared_context(x); }
      if let Some(x) = args.context_batch_schema { builder.add_context_batch_schema(x); }
      if let Some(x) = args.message_batch_schema { builder.add_message_batch_schema(x); }
      if let Some(x) = args.agent_batch_schema { builder.add_agent_batch_schema(x); }
      builder.finish()
    }
  ...
  pub fn agent_batch_schema(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(DatastoreInit::VT_AGENT_BATCH_SCHEMA, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn message_batch_schema(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(DatastoreInit::VT_MESSAGE_BATCH_SCHEMA, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn context_batch_schema(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(DatastoreInit::VT_CONTEXT_BATCH_SCHEMA, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn shared_context(&self) -> Option<SharedContext<'a>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<SharedContext>>(DatastoreInit::VT_SHARED_CONTEXT, None)
  }
}
...
impl flatbuffers::Verifiable for DatastoreInit<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"agent_batch_schema", Self::VT_AGENT_BATCH_SCHEMA, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"message_batch_schema", Self::VT_MESSAGE_BATCH_SCHEMA, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(&"context_batch_schema", Self::VT_CONTEXT_BATCH_SCHEMA, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<SharedContext>>(&"shared_context", Self::VT_SHARED_CONTEXT, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> DatastoreInitBuilder<'a, 'b> {
  #[inline]
  pub fn add_agent_batch_schema(&mut self, agent_batch_schema: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DatastoreInit::VT_AGENT_BATCH_SCHEMA, agent_batch_schema);
  }
  #[inline]
  pub fn add_message_batch_schema(&mut self, message_batch_schema: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DatastoreInit::VT_MESSAGE_BATCH_SCHEMA, message_batch_schema);
  }
  #[inline]
  pub fn add_context_batch_schema(&mut self, context_batch_schema: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DatastoreInit::VT_CONTEXT_BATCH_SCHEMA, context_batch_schema);
  }
  #[inline]
  pub fn add_shared_context(&mut self, shared_context: flatbuffers::WIPOffset<SharedContext<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<SharedContext>>(DatastoreInit::VT_SHARED_CONTEXT, shared_context);
  }
  #[inline]
...
impl<'a> NewSimulationRun<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
        args: &'args NewSimulationRunArgs<'args>) -> flatbuffers::WIPOffset<NewSimulationRun<'bldr>> {
      let mut builder = NewSimulationRunBuilder::new(_fbb);
      if let Some(x) = args.datastore_init { builder.add_datastore_init(x); }
      if let Some(x) = args.package_config { builder.add_package_config(x); }
      if let Some(x) = args.properties { builder.add_properties(x); }
      builder.add_sid(args.sid);
      if let Some(x) = args.sim_id { builder.add_sim_id(x); }
      builder.finish()
    }
  ...
  pub fn sim_id(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(NewSimulationRun::VT_SIM_ID, None).unwrap()
  }
  #[inline]
  pub fn sid(&self) -> u32 {
    self._tab.get::<u32>(NewSimulationRun::VT_SID, Some(0)).unwrap()
  }
  #[inline]
  pub fn properties(&self) -> &'a str {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(NewSimulationRun::VT_PROPERTIES, None).unwrap()
  }
  #[inline]
  pub fn package_config(&self) -> PackageConfig<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<PackageConfig>>(NewSimulationRun::VT_PACKAGE_CONFIG, None).unwrap()
  }
  #[inline]
  pub fn datastore_init(&self) -> DatastoreInit<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<DatastoreInit>>(NewSimulationRun::VT_DATASTORE_INIT, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for NewSimulationRun<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>(&"properties", Self::VT_PROPERTIES, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<PackageConfig>>(&"package_config", Self::VT_PACKAGE_CONFIG, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<DatastoreInit>>(&"datastore_init", Self::VT_DATASTORE_INIT, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b> NewSimulationRunBuilder<'a, 'b> {
  ...
  pub fn add_sim_id(&mut self, sim_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(NewSimulationRun::VT_SIM_ID, sim_id);
  }
  #[inline]
  ...
  pub fn add_properties(&mut self, properties: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(NewSimulationRun::VT_PROPERTIES, properties);
  }
  #[inline]
  pub fn add_package_config(&mut self, package_config: flatbuffers::WIPOffset<PackageConfig<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<PackageConfig>>(NewSimulationRun::VT_PACKAGE_CONFIG, package_config);
  }
  #[inline]
  pub fn add_datastore_init(&mut self, datastore_init: flatbuffers::WIPOffset<DatastoreInit<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<DatastoreInit>>(NewSimulationRun::VT_DATASTORE_INIT, datastore_init);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> NewSimulationRunBuilder<'a, 'b> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<NewSimulationRun<'a>> {
    ...
    self.fbb_.required(o, NewSimulationRun::VT_PROPERTIES,"properties");
    self.fbb_.required(o, NewSimulationRun::VT_PACKAGE_CONFIG,"package_config");
    self.fbb_.required(o, NewSimulationRun::VT_DATASTORE_INIT,"datastore_init");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub fn root_as_new_simulation_run(buf: &[u8]) -> Result<NewSimulationRun, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_new_simulation_run(buf: &[u8]) -> Result<NewSimulationRun, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a NewSimulationRun and returns it.
/// # Safety
...
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed NewSimulationRun and returns it.
/// # Safety
...
#[inline]
pub fn finish_size_prefixed_new_simulation_run_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<NewSimulationRun<'a>>) {
