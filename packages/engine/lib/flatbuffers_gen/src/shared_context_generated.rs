...
impl<'a> SharedContext<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args SharedContextArgs<'args>) -> flatbuffers::WIPOffset<SharedContext<'bldr>> {
  ...
  pub fn datasets(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch>>>>(SharedContext::VT_DATASETS, None).unwrap()
  }
}
...
impl flatbuffers::Verifiable for SharedContext<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Batch>>>>(&"datasets", Self::VT_DATASETS, true)?
     .finish();
    Ok(())
  }
}
pub struct SharedContextArgs<'a> {
    pub datasets: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Batch<'a>>>>>,
}
...
impl<'a: 'b, 'b> SharedContextBuilder<'a, 'b> {
  #[inline]
  pub fn add_datasets(&mut self, datasets: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Batch<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SharedContext::VT_DATASETS, datasets);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SharedContext<'a>> {
    ...
    self.fbb_.required(o, SharedContext::VT_DATASETS,"datasets");
