...
impl<'a> RunnerError<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args RunnerErrorArgs<'args>) -> flatbuffers::WIPOffset<RunnerError<'bldr>> {
  ...
  pub fn msg(&self) -> Option<&'a str> {
    self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RunnerError::VT_MSG, None)
  }
}
...
impl<'a: 'b, 'b> RunnerErrorBuilder<'a, 'b> {
  ...
  pub fn add_msg(&mut self, msg: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RunnerError::VT_MSG, msg);
  }
  #[inline]
...
pub fn size_prefixed_root_as_runner_error(buf: &[u8]) -> Result<RunnerError, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_runner_error_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<RunnerError<'a>>) {
