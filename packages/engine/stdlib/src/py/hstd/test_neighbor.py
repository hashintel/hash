...
from .neighbor import neighbors_on_position, neighbors_in_radius, neighbors_in_front, neighbors_behind
...
def test_max_radius():
    in_radius = neighbors_in_radius(ng, [na, nb, nc, nd, ne, nf, nh, ni], 3, distance_function='chebyshev')
...
def test_max_min_radius():
    ...
    in_radius_2 = neighbors_in_radius(ng, [na, nb, nc, nd, nf, nh, ni, nj], 7, 3.5, 'euclidean', True)
