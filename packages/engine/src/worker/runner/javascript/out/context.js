(hash_util) => {
  ...
  const gen_agent_ctx = (ctx_schema, getters) => {
    const AgentContext = function(ctx_batch, state_snapshot, current_step, i_agent_in_sim, globals, experiment_ctx) {
      this.__experiment_ctx = experiment_ctx;
      this.__ctx_batch = ctx_batch;
      this.__cols = ctx_batch.cols;
      this.__current_step = current_step;
      this.__idx_in_sim = i_agent_in_sim;
  ...
  const gen_group_ctx = (AgentContext) => {
    const GroupContext = function(ctx_batch, state_snapshot, current_step, group_start_idx, globals, experiment_ctx) {
      this.__experiment_ctx = experiment_ctx;
      this.__globals = globals;
      this.__ctx_batch = ctx_batch;
    ...
    GroupContext.prototype.get_agent = function(i_agent_in_group, old_agent_ctx) {
      ...
      return Object.seal(new AgentContext(this.__ctx_batch, this.state_snapshot, this.__current_step, idx_in_sim, this.__globals, this.__experiment_ctx));
    };
  ...
  const gen_sim_ctx = (ctx_schema, getters) => {
    ...
    SimContext.prototype.set_batch = function(ctx_batch, state_group_start_idxs, current_step) {
      this.__ctx_batch = ctx_batch;
    ...
    SimContext.prototype.get_group = function(i_group) {
      return Object.seal(new GroupContext(this.__ctx_batch, this.state_snapshot, this.__current_step, this.__group_start_idxs[i_group], this.__globals, this.__experiment_ctx));
    };
    SimContext.prototype.get_agent = function(i_agent_in_sim, old_agent_ctx) {
      ...
      return Object.seal(new AgentContext(this.__ctx_batch, this.state_snapshot, this.__current_step, i_agent_in_sim, this.__globals, this.__experiment_ctx));
    };
