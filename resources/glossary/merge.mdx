...
Merging is the process of reconciling two projects together. Typically in HASH, this refers to the process of merging a [forked project](https://hash.ai/wiki/fork) with the original project from which it was derived.
...
1.  **Line-by-line diffing (automatic)**: a [diff](https://hash.ai/wiki/diff) will be automatically produced. If no changes have occurred on the
2.  **Human-review process (optional)**: as part of this review process, the diff of a proposed merge may be inspected by a human: usually a nominated maintainer of the _target_ project.
