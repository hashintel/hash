...
Data pipelines are processes (typically represented as [DAGs](https://hash.ai/wiki/dag)) that result in the production of data products, including datasets and models.
