...
Model drift can have different causes, but broadly speaking it's due to either 'concept drift', where the variable definitions have changed, or 'data drift', where the underlying real world data has changed.
