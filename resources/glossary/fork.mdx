...
It can also be desirable to create a fork of something as a backup, in the event you are uncertain whether the original project or repository will remain accessible in future. Once a project has been forked, a copy of it (including any code or data within) exists in your namespace. However, forked projects may still be subject to the [licensing terms](https://hash.ai/wiki/model-licensing) of the original publisher.

Forked projects can be [diffed](https://hash.ai/wiki/diff) against any version of another project to see how they have evolved over time. This is especially helpful in the [merge process](https://hash.ai/wiki/merge).
