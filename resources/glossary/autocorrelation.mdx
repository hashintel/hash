...
Autocorrelation is a measure of the degree of similarity between any [time series](https://hash.ai/wiki/time-series) and a lagged or offset version of itself over successive time intervals.
