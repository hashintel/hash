...
Analyzing this data in real time, by [connecting streaming sources in HASH](https://hash.ai/platform), allows for future behavior to be anticipated — useful in and of itself, as well as providing a basis for more accurate [agent-based simulation](https://hash.ai/wiki/simulation).

Time series data often has internal structures that can be analyzed (such as a tendency to [autocorrelate](https://hash.ai/wiki/autocorrelation), as well as trend or seasonal variation).
