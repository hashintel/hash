...
2.  simulations that are made public — for example published to [hIndex](https://hash.ai/platform/index), the largest repository of transparently shared simulations in the world.
...
=======
When a simulation is shared in a transparent fashion, it may still be copyrighted, or subject to other [license terms](https://hash.ai/wiki/model-licensing).
>>>>>>> c6c98ac (upload last set of pages)
=======
When a simulation is shared in a transparent fashion, it may still be copyrighted, or subject to other [license terms](https://hash.ai/glossary/model-licensing).
>>>>>>> 039db30 (replace all references to wiki with glossary)
