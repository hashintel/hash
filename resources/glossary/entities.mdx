---
objectId: 5f7f8d88-0205-2222-f46f-0ba3791t4616
title: Entities
...
In the real world, entities are often connected to other entities.

Sometimes these connections take the form of social relationships (e.g. “Mother <> Child” or “Friend <> Friend”) occurring between entities of the same [entity type] (in this case `Person`).
...
If you’re using our advanced [HASH for simulation](https://hash.ai/index) platform, you might be wondering about the relationship between entities and [agents](https://hash.ai/glossary/agent-based-modeling). For all practical purposes, you can think of both as the same thing. In future releases of [hCore](https://hash.ai/platform/core) and [hEngine](https://hash.ai/platform/engine) we’ll support instantiating entities from a HASH workspace directly within simulations (as agents), as well as assigning expected [behaviors](https://hash.ai/docs/simulation/creating-simulations/behaviors) to entity types in [HASH](https://hash.ai/platform/hash).
