...
Neurons are typically arranged in layers, performing different transformations on their inputs. The first layer is known as the **inputlayer**, and the last is the **output****layer**.
