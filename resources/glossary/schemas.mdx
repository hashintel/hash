...
If a sub-type or top-level schema you require doesn’t exist, you can create one with HASH from scratch, or by [forking](https://hash.ai/wiki/fork) an existing one.
