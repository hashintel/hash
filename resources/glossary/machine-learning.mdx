...
description: general introduction to how Machine Learning could be applied in the context of multi-agent simulations
slug: machine-learning
---

## WHAT IS MACHINE LEARNING

**Machine Learning** is a sub-field of Artificial Intelligence where algorithms learn from interacting with an **environment** or from a **training dataset**. Machine Learning is primarily used to make **predictions** using statistics, applying those statistical methods to business problems is the realm of **predictive analytics**. Most recent advances in Machine Learning have been driven by research in Deep Learning, which is the combination of Machine Learning and multi-layer [artificial neural networks](https://hash.ai/glossary/neural-nets).

<p align="center">
![Artificial Intelligence Machine Learning Deep Learning](https://i.imgur.com/xatMpJa.png)
</p>
...
The three most important approaches in machine learning are supervised learning, unsupervised learning and reinforcement learning. Other methods such as [data mining](https://hash.ai/glossary/data-mining), semi-supervised learning or feature learning make use of those three essential methods listed above. Although Deep Learning has been the most popular paradigm in Machine Learning in the past 5 years, traditionally machine learning has made extensive use of decision trees, support-vector machines, bayesian networks and genetic algorithms. 
...
6. **Support-vector machines**: can work for both classification and regression, by mapping the inputs into another higher-dimensional space, using what is known as _the kernel trick_.

7. **Bayesian Networks**: assumes the training data is a table of multiple variables with dependencies that can be modeled by a [direct acyclic graph](https://hash.ai/wiki/dag). The graph, called **bayesian network**, can be used to compute probability distribution using chain rules and conditional probabilities. The resulting model is easily interpretable and is therefore sometimes preferred over black box solutions such as deep neural networks.
...
HASH's [platform](https://hash.ai/platform) allows to create environments for multi-agent simulations. These can be modified for synchronous multi-agent reinforcement learning problems, where each agent navigates and discovers solutions of arbitrarily complex systems. It is also possible to simulate entire population of agents and run genetic algorithms.
