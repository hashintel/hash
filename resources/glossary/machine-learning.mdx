...
**Machine Learning** is a sub-field of Artificial Intelligence where algorithms learn from interacting with an **environment** or from a **training dataset**. Machine Learning is primarily used to make **predictions** using statistics, applying those statitical methods to business problems is the realm of **predictive analytics**. Most recent advances in Machine Learning have been driven by research in Deep Learning, which is the combination of Machine Learning and multi-layer [artificial neural networks](https://hash.ai/wiki/neural-nets).

![Artificial Intelligence Machine Learning Deep Learning](https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Fig-X_All_ML_as_a_subfield_of_AI.jpg/800px-Fig-X_All_ML_as_a_subfield_of_AI.jpg)
