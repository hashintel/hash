...
2.  the graph as a whole contains no cycles (aka. _loops_).
...
<figure class="wp-block-image size-large is-style-default">
  ![A Directed Acylic Graph in
  HASH](https://cdn-us1.hash.ai/site/dag-example.png)
</figure>
...
- **[data pipelines](https://hash.ai/wiki/data-pipelines):** the decision and processing steps taken as data flows through a pipeline
